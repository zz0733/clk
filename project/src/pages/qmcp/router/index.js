...
const vpHome = r => require.ensure([], () => r(require('@/pages/qmcp/home/vp-hall/index')), 'vpHome');
      ...
      children:
        [
          // 注册登录
          {
            path: '/admin/login',
            name: 'login',
            component: resolve => require(['@/pages/qmcp/admin/login.vue'], resolve)
          },
          {
            path: '/admin/register',
            component: 'register',
            component: resolve => require(['@/pages/qmcp/admin/register.vue'], resolve),
