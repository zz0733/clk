  ...
  <div class="container-register">
    ...
    <div class="row">
      <div class="box">
        ...
        <cube-input v-model="userName" type="text" placeholder="账号(5-20位数字或字母)" id="userName" @blur="getCode"></cube-input>
      </div>
    </div>
    ...
    <div class="row">
      <div class="box">
        ...
        <cube-input v-model="password" type="password" placeholder="密码(5-20位数字或字母)"></cube-input>
      </div>
    </div>
    <div class="row">
      <div class="box">
    ...
    <div class="submit-wrap">
      ...
      <div @touchstart="submitRegister" @click="submitRegister" class="submitBt">立即注册</div>
    </div>
...
export default {
  ...
  created() {
    this.$nextTick(() => {
      ...
      let registerH5 = JSON.parse(localStorage.getItem("config")).register.h5;
