...
<div class="team">
  ...
  <div class="content">
        ...
        <van-collapse v-model="activeName" accordion>
          <van-collapse-item :name="i+1" v-for="(item,i) in teamData" :key="i">
            <div slot="title">
              ...
              <span>{{item.rebate.toFixed(2)}}</span>
    ...
    <div v-if="!teamData.length" style='margin:100px 0;text-align: center;'><img src='../../../../../assets/img/public/image/common/personal/userInfo/no-data.png' width="60%" alt=''></div>
  </div>
  ...
  <van-datetime-picker :max-date='new Date()' class="time-picker" v-model="currentDate" type="date" v-if="teamTimeShow" @cancel="hanldCalDate" @confirm="hanlderTeamTime" />
