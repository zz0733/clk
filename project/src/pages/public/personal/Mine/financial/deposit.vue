...
<div class="pay-money">
  <div class="pay-list">
    <cube-scroll ref="scroll" :data="paylist">
      <van-cell-group>
        <van-cell v-for="(pay,i) in paylist" :key="i" :title="pay.className" is-link :label="pay.classRemarks" @click="$router.push({path:'deposit_submit',query:{classType:pay.classType,name:pay.className,id:pay.id}})">
          <template slot="icon">
        ...
        .then(res => {
          if (res.code == 200) {
            ...
            this.paylist.unshift({
              ...
              className: "银行转账",
              id: "0",
              classIcon: require("../../../../../assets/img/public/image/common/personal/userInfo/bank-zz.png")
            });
