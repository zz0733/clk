  ...
  <div class="all-container-wrap">
    <transition name="fade">
      <div class="all-container-betArea">
        ...
        <vp-nav class="pcDdZhuShi" :childNeedMess='childNeedMess' :sideReady='sideReady' :side='side' v-on:child-say="getListData"></vp-nav>
              ...
              <div class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                ...
                <ul class="lottery-ul">
                  <li :class="{
                    ...
                    +intItem.code==27}" class="ball">{{intItem.name}}</div>
        ...
        <cube-popup :style="{position:position }" type="vp-submit" ref="mySumit">
          <transition name="fade">
            <vp-lottery-submit :childNeedMess="childNeedMess" v-if="showSubmit" v-on:hidePopup="hidePopup" v-on:allSubmit="allSubmit" :submitList="submitListPrime" :total="total"></vp-lottery-submit>
          </transition>
        </cube-popup>
        <transition name="fade">
