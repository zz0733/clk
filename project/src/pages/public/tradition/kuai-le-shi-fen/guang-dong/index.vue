          ...
          if (datas == "快捷") {
            ...
            this.showList.list.unshift({
              ...
              code: [
                ...
                {name:"第六球", code: "第六球", id: "球号6", odds: "", playway: "", state: false },
                {name:"第七球", code: "第七球", id: "球号7", odds: "", playway: "", state: false },
                {name:"第八球", code: "第八球", id: "球号8", odds: "", playway: "", state: false }
              ]
            });
          }
          if (datas.includes("球")) {
    ...
    async allSubmit() {
      ...
      this.submitList.forEach(item => {
        submitArr.push({
          ...
          odds: item.odds,
          money: submitMoney,
          ball:this.sideSelect.includes('球')&&this.sideSelect.includes('第')?this.sideSelect:item.intTitle,
          attach: ""
        });
      });
