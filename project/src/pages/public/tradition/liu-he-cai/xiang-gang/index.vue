    ...
    <transition name="fade">
      <div class="all-container-betArea">
        ...
        <div class="betArea-decial-box">
          <div class="lottery-cont" ref="lottery-cont">
              ...
              <div class="horizontal-scroll-list-wrap">
                <cube-scroll :data="shengXiaoLianList" direction="horizontal">
                  <ul class="list-wrapper">
                    <li :class="{'active':item.name==shengXiaoLianActive}" @click="shengXiaoLianFc(index,item.name)" class="list-item cube-scroll-lianMa-item" :key="index" v-for="(item,index) in shengXiaoLianList">
            ...
            <div v-if="sideSelect=='连尾'">
              <div class="horizontal-scroll-list-wrap">
                <cube-scroll :data="weiShuLianList" direction="horizontal">
                  <ul class="list-wrapper">
                    <li :class="{'active':item.name==weiShuLianActive}" @click="weiShuLianFc(index,item.name)" class="list-item cube-scroll-lianMa-item lianWei" :key="index" v-for="(item,index) in weiShuLianList">
                      <div>{{item.name.substring(0,3)}}</div>
                      <div>({{item.name.substring(3,item.name.length)}})</div>
                    </li>
                  </ul>
            ...
            <div class="wrap" v-if="sideSelect=='特码'">
              <div v-if="outItem.small==active.teMol" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <ul class="lottery-ul ballPadding">
                  <li :class="{
                                                'fourSquare':
                                                outItem.title=='拆分'
                                            }" @click="addActiveFc(intItem)" class="lottery-item te" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
                                                ...
                                                }" class="ball ballTe">{{intItem.name}}</div>
            ...
            <div class="wrap" v-if="sideSelect=='正码'">
              <div v-if="outItem.small==active.zhengMol" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
            ...
            <div class="wrap" v-if="sideSelect=='正码特'">
              <div v-if="outItem.small==active.zhengTMol" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <!-- <div class="lottery-title">{{outItem.small}}</div> -->
                <ul class="lottery-ul ballPadding">
                  <li :class="{
                                                'fourSquare':
            ...
            <div class="wrap" v-if="sideSelect=='正码1-6'">
              <div class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                ...
                <ul class="lottery-ul one-to-six">
                  <li @click="addActiveFc(intItem)" class="lottery-item fourSquare one-to-six-child" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
            ...
            <div class="wrap" v-if="sideSelect=='连码'">
              <div v-if='active.lianmaMol==outItem.small' class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <!-- <div class="lottery-title">{{outItem.small}}</div> -->
                <ul class="lottery-ul ballPadding">
                  <li @click="addActiveFc(intItem)" class="lottery-item te" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
                                                    blue:+intItem.code==3&&intItem.state||+intItem.code==9&&intItem.state||+intItem.code==15&&intItem.state||
                                                    +intItem.code==25&&intItem.state||+intItem.code==31&&intItem.state||+intItem.code==37&&intItem.state||
                                                    +intItem.code==41&&intItem.state||+intItem.code==47&&intItem.state||+intItem.code==4&&intItem.state||
            ...
            <div class="wrap" v-if="sideSelect=='过关'">
              <div class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <div class="lottery-title">{{outItem.small}}</div>
                <ul class="lottery-ul">
                  <li @click="addActiveFc(intItem)" class="lottery-item fourSquare " :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{ 'active':intItem.state}" class="ball">{{intItem.name}}</div>
                    <div :class="{'active':intItem.state}" class="odd">{{intItem.odds}}</div>
                  </li>
                </ul>
            ...
            <div class="wrap" v-if="sideSelect=='全不中'">
              <div v-if="active.quanBuZhongMol==outItem.small" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <!-- <div class="lottery-title">{{outItem.small}}</div> -->
                <ul class="lottery-ul ballPadding">
                  <li @click="addActiveFc(intItem)" class="lottery-item te " :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
            ...
            <div class="wrap" v-if="
                               ...
                               sideSelect=='一肖'
                            ">
              <div @click="weiShuActiveFc(outItem)" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
            ...
            <div class="wrap" v-if="
                               sideSelect=='连肖'
                            ">
              <div v-if="outItem.secondTitle==active.shengXiaoLianMol" @click="weiShuActiveFc(outItem)" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <div class="lottery-title">{{outItem.small}}　{{outItem.odds}}</div>
                <ul class="lottery-ul trail">
                  <li class="lottery-item te" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
            ...
            <div class="wrap" v-if="
                               sideSelect=='连尾'
                            ">
              <div v-if="outItem.secondTitle==active.weiShuLianMol" @click="weiShuActiveFc(outItem)" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <div class="lottery-title">{{outItem.small}}　{{outItem.odds}}</div>
                <ul class="lottery-ul trail">
                  <li class="lottery-item te" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
            ...
            <div class="wrap" v-if="
                               sideSelect=='合肖'
                            ">
              <div v-if="outItem.secondTitle==active.heXiaoMol" @click="weiShuActiveFc(outItem)" class="list" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <div class="lottery-title">{{outItem.small}}　{{outItem.odds}}</div>
                <ul class="lottery-ul trail">
                  <li class="lottery-item te" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                    <div :class="{
            ...
            <div class="wrap" v-if="sideSelect=='色波'">
              <div v-if="active.seBoMol==outItem.small" class="list style-seBo-box" :key=outIndex v-for="(outItem,outIndex) in showList.list">
                <div @click="addActiveFc(intItem)" :key=intIndex v-for="(intItem,intIndex) in outItem.code">
                  ...
                  <ul class="lottery-ul">
                    <li :key=thirdIndex v-for="(thirdItem,thirdIndex) in intItem.list" class="lottery-item  te style-seBo">
                      <div :class="{
                                                            ...
                                                            }" class="ball fontSebo">{{thirdItem}}</div>
        ...
        <cube-popup :style="{position:position }" type="vp-submit" ref="mySumit">
          <transition name="fade">
            <vp-lottery-submit :childNeedMess="childNeedMess" v-if="showSubmit" v-on:hidePopup="hidePopup" v-on:allSubmit="allSubmit" :submitList="submitListShow.length?submitListShow:submitList" :total="total" :sideSelect="sideSelect" :childSelect="active.heXiaoMol"></vp-lottery-submit>
          </transition>
        </cube-popup>
        <transition name="fade">
          <vp-lottery-sec-money v-show="total.num&&total.num>0" v-on:sec-money-say="reset" v-on:showPopup="showPopup" v-on:calculate="calculate" :total=total ref="selMoney"></vp-lottery-sec-money>
        </transition>
