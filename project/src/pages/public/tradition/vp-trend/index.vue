      ...
      <div class="scroll-list-wrap">
        <cube-scroll ref="scroll" :options="options" @pulling-down="onPullingDown" @pulling-up="onPullingUp">
          <div class="item-box">
                ...
                <div class="resultInfo">
                  <div class="box">
                    <div :class="{
                      ...
                      }" class="ball" :key=intIndex v-for=" (intItem,intIndex) in  outItem.resultInfo">{{intItem}}</div>
                  </div>
                </div>
                <div class="luzhu">
                  <div class="box">
            ...
            <img class="nodataImg" v-if="noDatas" src="../../../../assets/img/public/image/common/home/noDatas.png" alt="">
          </div>
        </cube-scroll>
