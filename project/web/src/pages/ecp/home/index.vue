            ...
            <div class="problem">
              ...
              <div class="common">
                <ul class="clearfix">
                  ...
                  <li><a href="https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=833593&configID=41254&jid=7920496573&s=1" target="_blank">联系我们</a></li>
                </ul>
              </div>
            </div>
          </div>
...
.new-index {
  ...
  .ecp-bot-wrap {
    ...
    .content {
      ...
      .content_middle {
        height: 280px;
        background: url(/static/ecp/img/index-downlogo-bg.jpg?2422a3e65a) left
          top no-repeat;
        .btn {
          width: 230px;
          ...
          a {
            ...
            width: 195px;
            height: 70px;
            background: url(/static/ecp/img/index-down-btn.png?016eed19e5) left
              top no-repeat;
            &.ios {
        ...
        .con {
          ...
          h3 {
            width: 100%;
            height: 122px;
            background: url(/static/ecp/img/download-item-tit.png?db2f2f07b1)
              left top no-repeat;
          }
          p {
            width: 100%;
            ...
            height: 25px;
            margin-top: 30px;
            background: url(/static/ecp/img/download-item-con.png?aa97959532)
              left top no-repeat;
          }
        }
      }
