              ...
              <div class="game_kind clearfix">
                <div class="kind_bg">
                  <div class="game_kind_in kind_bg_c">
                    ...
                    <a href="javascript:void(0);" class="credits" @click="$router.push('/plays/tradition/2')"></a>
                  </div>
                </div>
                <div class="kind_bg kind_bg_ml">
                  <div class="game_kind_in kind_bg_o">
                    <a href="javascript:void(0);" class="credit_a"></a>
                    <a href="javascript:void(0);" class="credits" @click="$router.push('/plays/tradition/4')"></a>
                  </div>
                </div>
                <div class="kind_bg kind_bg_ml">
                  <div class="game_kind_in kind_bg_s">
                    <a href="javascript:void(0);" class="credit_a"></a>
                    <a href="javascript:void(0);" class="credits" @click="$router.push('/plays/tradition/9')"></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="problem">
                ...
                <div class="common">
                  <ul class="clearfix">
                    ...
                    <li><a href="https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=833595&amp;configID=41239&amp;jid=6003561671&amp;s=1" target="_blank">联系客服</a></li>
                  </ul>
                </div>
              </div>
            </div>
    ...
    .lottery-wrap {
      .game_kind {
        .kind_bg {
          ...
          .kind_bg_c {
            background: url(/static/qmcp/img/kind_bg_c.png) no-repeat bottom
              left;
            .credit_a {
          ...
          .kind_bg_o {
            background: url(/static/qmcp/img/kind_bg_o.png) no-repeat bottom
              left;
            .credit_a {
          ...
          .kind_bg_s {
            background: url(/static/qmcp/img/kind_bg_s.png) no-repeat bottom
              left;
            .credit_a {
      ...
      .advantages {
        ...
        .payment_date {
          ...
          .time_bar {
            ...
            float: left;
            position: relative;
            background: url(/static/qmcp/img/others_all.png?d2dd213127)
              no-repeat 0 -228px;
            .bar_slide {
              width: 112px;
              height: 18px;
...
.vp-popout-box {
  ...
  /deep/ .ivu-modal-header {
    ...
    background: #ff0000
      url(/static/hsyl/img/ui-bg_gloss-wave_45_817865_500x100.png) 50% 50%
      repeat-x;
    color: #ffffff;
    font-weight: bold;
    position: relative;
