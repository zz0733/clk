<template>
  <div class="footer">
    <div class="w1200">
      <p class="foot_title"></p>
      <p class="foot">Copyright © E赢彩 Reserved</p>
    </div>
...
.footer {
  ...
  .foot_title {
    height: 68px;
    background: url(/static/eyc/img/foot-logo.png) center no-repeat;
  }
  .foot {
    height: 30px;
    line-height: 30px;
  ...
  .mobile_auto {
    ...
    width: 302px;
    height: 260px;
    background-image: url(/static/eyc/img/APPxx.png);
    .clBtn {
      position: absolute;
      right: 40px;
      top: 5px;
