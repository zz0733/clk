    ...
    <div class="banner-wrap">
      <div class="carouse">
        ...
        <div class="login_cont2" v-if="!userinfo">
          ...
          <ul>
            <li>
              <input type="text" v-model="passKey.userName" placeholder="用户名" tabindex="1" @blur="getCode">
              <span class="login-title1"></span>
            </li>
            <li>
              <input type="password" v-model="passKey.password" placeholder="密码" autocomplete="off" tabindex="2">
              <span class="login-title2"></span>
            </li>
            <li>
              <input name="rmNum" v-model="passKey.code" type="text" id="rmNum" placeholder="验证码" tabindex="3">
              <img class="code" :src="codeImg" @click="getCode">
              <span class="login-title3"></span>
            </li>
            <li class="text-left">
              <a href="javascript:void(0)" onclick="alert('忘记账号，请联系在线客服人员取回！');">忘记密码？</a>
          ...
          <div class="content clearfix">
            <div class="item fl clearfix" v-for="lottery in lotteryList" :key="lottery.router">
              ...
              <div class="fr">
                ...
                <a class="path" :href="lottery.router" target="_blank">进入游戏</a>
              </div>
            </div>
          </div>
        </div>
      ...
      .login_cont2 {
        ...
        li {
          ...
          span {
            ...
            width: 40px;
            height: 35px;
            background: url(/static/eyc/img/icon/login-title.png) center
              no-repeat;
            position: absolute;
            top: 0px;
