    ...
    <div class="w1200">
      ...
      <div class="fr right">
        <ul>
          ...
          <li>|</li>
          <li><a class="aa" href="/m/#/">手机投注</a></li>
          <li>|</li>
          <li><a class="yhhd" :style="style" href="javascript:void(0);">优惠活动<img class="mg" src="/static/eyc/img/icon/hot.gif"></a></li>
          <li>|</li>
          <li><a class="aa" href="javascript:void(0);">在线客服</a></li>
          <li>|</li>
