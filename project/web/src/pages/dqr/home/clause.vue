<template>
    <div class="clause">
        <div class="content">
            <div class="logo">
                <img src="/static/dqr/img/logo.png">
            </div>
                <div class="rulesBody">
                    ...
                    <div class="footer">Copyright &copy; 地球人彩票 Reserved</div>
                </div>
            </div>
</template>
<script>
        ...
        <div id="rule_all">
            <div class="width655">
                ...
                <ol>
                    ...
                    <li class="title-style1">若本公司发现会员有重复申请帐号行为时，保留取消、收回会员所有优惠红利，以及优惠红利所产生的盈利之权利。每位玩家、每一住址、每一电子邮箱、每一电话号码、相同支付卡/信用卡号码，以及共享电脑环境 (例如:网吧、其他公共用电脑等)只能够拥有一个会员帐号，各项优惠只适用于每位客户在本公司唯一的帐户。</li>
                    <li class="title-style1">地球人彩票拥有对所有游戏规则与条款的修改权和最终解释权。</li>
                </ol>
...
const rule_ipl = {
  template: `<div id="rule_ipl">
                ...
                （b）若牌局未开牌，荷官避开扫描如常开牌后，工务将输入牌之正确数码，并修正不符那张牌的 花色、点数，牌局会如常继续。</li>
                        ...
                        <li class="title-style1">地球人彩票之视讯为真人直播，故该局游戏若因国际线路传输问题出现争议，将以视讯看到牌局结果决定输赢。</li>
                        <li class="title-style1">地球人彩票所提供之牌路仅供参考，若因国际线路问题或其他因素造成牌路显示有误，所有游戏结果将以视讯开牌及游戏纪录为主。</li>
                        <li class="title-style1">本公司保留一切有争议事项的修正及最后的决策。</li>
                        <li class="title-style1">地球人彩票保留随时更改、修订或删除游戏、游戏规则（包括机率及赔率）及协议条款的权利而无须作事先通知。</li>
                        <li class="title-style1">地球人彩票保留随时修订、撤销或中止任何投注的权利而无须作事先通知，亦无须作任何解释。</li>
                        <li class="title-style1">地球人彩票纪录每一项于本网站伺服器内执行的交易及投注功能。若会员认为向本娱乐城提供的资料与本网站资料库中的资料纪录之间出现了任何声称的差异，一切均以本网站资料库的资料为准。</li>
                        <li class="title-style1">当会员已于地球人彩票之游戏厅内下注，而电脑出现连线异常导致牌局中断时，会员最后押住仍视为有效，本娱乐城将以会员于本网站资料库的交易纪录为准。</li>
