            ...
            <div class="middle_top clear animated fadeInDownBig">
              <div class="top_games clear">
                ...
                <div class="games_box ml_none mt">
                    <a @click="goTo({type:'lottery',router:'#/plays/tradition/3'});" href="javascript:void(0);" class="game_icon">
                        <span class="game_icon_4"></span>
                    </a>
                    <div class="lottery_species">
                        <a class="species_center" @click="goTo({type:'lottery',router:'#/plays/tradition/3'});" href="javascript:void(0);">
                            幸运飞艇
                        </a>
                    </div>
                </div>
      ...
      <div class="download_link">
        ...
        <div class="mobile_client">
            ...
            <div class="client_erweima">
                ...
                <p v-show="mobileDow=='android'"><img src="/static/dqr/img/android.png" alt="ANDROID" width="104" height="104"></p>
            </div>
        </div>
      </div>
    </div>
