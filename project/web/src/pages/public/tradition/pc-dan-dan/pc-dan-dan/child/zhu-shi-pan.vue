                        ...
                        <div class="all-item">
                            <div class="box">
                                <Select v-model="selectBaoSan.ball1" class="select-common-css baosan">
                                    <Option v-for="item in selectBaoSan.ballList1" :value="item.num" :key="item.id">{{ item.num }}</Option>
                                </Select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="all-item">
                            <div class="box">
                                <Select v-model="selectBaoSan.ball2" class="select-common-css baosan">
                                    <Option v-for="item in selectBaoSan.ballList2" :value="item.num" :key="item.id">{{ item.num }}</Option>
                                </Select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="all-item">
                            <div class="box">
                                <Select v-model="selectBaoSan.ball3" class="select-common-css baosan">
                                    <Option v-for="item in selectBaoSan.ballList3" :value="item.num" :key="item.id">{{ item.num }}</Option>
                                </Select>
                            </div>
                        </div>
                    </div>
  ...
  methods: {
    ...
    submit() {
      ...
      this.submitList.forEach((item)=>{
        ...
        if(item.ball=='特码包三'){
          submitArr.push({"code":this.selectBaoSan.ball1,"playway":item.code,"odds":item.fixedOdds,"money":finalModel,"ball":item.title,"attach":""})
          submitArr.push({"code":this.selectBaoSan.ball2,"playway":item.code,"odds":item.fixedOdds,"money":finalModel,"ball":item.title,"attach":""})
          submitArr.push({"code":this.selectBaoSan.ball3,"playway":item.code,"odds":item.fixedOdds,"money":finalModel,"ball":item.title,"attach":""})
        }else{
          submitArr.push({"code":item.ball,"playway":item.code,"odds":item.fixedOdds,"money":finalModel,"ball":item.title,"attach":""})
        }
     })
