            ...
            <ul style="margin-left: 25px;">
                ...
                <ul style="list-style: decimal;">
                    ...
                    <li>选项可列为：
                        <ul style="list-style: lower-alpha">
                            <li>
                                <strong>任意球：</strong>球必须是直接踢进的方式。间接行的任意球如果最后是罚球者本人踢进则计算在内。 </li>
                            <li>
                                <strong>点球：</strong>球必须是由罚球者本人直接踢进的方式。若遇到补射的情况，即使是罚球者本人踢进也将不计算在内。 </li>
                            <li>
                                <strong>乌龙球：</strong>球必须授予为乌龙球。 </li>
                            <li>
                                <strong>头球：</strong>进球者必须明确的用头进球。 </li>
                            <li>
                                <strong>射门：</strong>所有其他的进球方式。除了以上所列出的方式，所有其他进球的方式都包含在此方式。 </li>
                            <li>
                                <strong>没有进球：</strong>赛事没有进球。 </li>
                        </ul>
                    </li>
                </ul>
                <p class="b sub">
