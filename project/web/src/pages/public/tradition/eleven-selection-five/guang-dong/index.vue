  ...
  <div class="container">
    ...
    <div class="cp-container-wrap">
        ...
        <transition name="fade" mode="out-in">
          ...
          <vp-ch-lia-mian-pan ref="content"    :oddsListPar="oddsListPar"  :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='两面盘'"></vp-ch-lia-mian-pan>
          <vp-ch-zu-he ref="content"   :oddsListPar="oddsListPar"  :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='快捷'"></vp-ch-zu-he>
        </transition>
    </div>
