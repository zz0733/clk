<template>
    <div  class="vp-trend-header">
        <nav class="vp-trend-nav">
            <ul>
                <li @click="trendSelectFc(item,index)" :class="{'active':item.id==getNavDatas.active}"  v-for="(item,index) in getNavDatas.list" :key=index>
                    <a>{{item.name}}</a>
                </li>
            </ul>
        </nav>
        <div class="vp-trend-navChild">
            <ul :class="{'active':getNavDatas.active=='999'}">
                ...
                <li @click="trendSelChil(item,index)" :class="{'active':item.id==navDatasChi.active}"  v-for="(item,index) in navDatasChi.list" :key=index>
                    <a>{{item.name}}</a>
                </li>
            </ul>
        </div> 
