            ...
            <div class="trend-left-box">
              <div class="trend-left-box-top">
                ...
                <div class="td-issue">
                  ...
                  <div :key="index" v-for="(item,index) in newDatas.leftDatas.newTime" class="issue-number">{{item}}</div>
                </div>
                <!-- 开奖号 -->
                ...
                <div class="td-lottery-wide">
                  ...
                  <div class="wide-wrap" :key="outIndex" v-for="(outItem,outIndex) in newDatas.leftDatas.newSingle">
                    <div class="wide-inner-wrap">
                      <div :class="{
                                        'active':intItem=='大'||intItem=='单'||intItem=='上'||intItem=='奇',
                                        'active2':intItem=='总尾大',
                                        'active3':intItem=='和',
                                        'blue':intItem=='蓝',
                                        'green':intItem=='绿',
                                        'red':intItem=='红'
                                    }" :style="{'width':intItem.length>=3?88+'px':60+'px'}" :key="intIndex" v-for="(intItem,intIndex) in outItem" class="item">{{intItem}}</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          for (let key in item) {
            ...
            switch (key) {
              ...
              case "resultInfo":
                ...
                break;
              case "openingTime":
                this.newDatas.leftDatas.newTime.push(
                  this.$moment
                    .unix(item.openingTime)
