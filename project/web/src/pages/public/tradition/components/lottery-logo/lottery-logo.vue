              ...
              <div class="lottery-logo">
                ...
                <div class="title-wrap">
                    ...
                    <div class="number">
                        ...
                        <span v-if="$route.meta.id==12||$route.meta.id==16||$route.meta.id==18||$route.meta.id==24||$route.meta.id==27">1152</span>
                        ...
                        <span v-else-if="$route.meta.id==14">96</span>
                        <span v-else-if="$route.meta.id==15">84</span>
                        <span v-else-if="$route.meta.id==6">97</span>
                        <span v-else-if="$route.meta.id==2900">89</span>
                        <span v-else-if="$route.meta.id==2901">72</span>
                        <span v-else-if="$route.meta.id==2902||$route.meta.id==2903||$route.meta.id==2905">78</span>
                        <span v-else-if="$route.meta.id==2904">81</span>
                        <span v-else-if="$route.meta.id==25">80</span>
                        <span v-else-if="$route.meta.id==22">90</span>
                        <span v-else-if="$route.meta.id==23">87</span>
