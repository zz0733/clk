    ...
    <div v-show="ifTrend" class="lottery-luzhu">
            ...
            <div class="decial-3-history">
                ...
                <div class="list" :key="indexOut" v-for="(itemOut,indexOut) in datas.lastData">
                    <div class="list-item" :style="{zIndex:datas.lastData.length+100-indexInner-indexOut}" :key="indexInner"  v-for="(itemInner,indexInner) in itemOut.list">
                      <span :class="{
...
export default {
    ...
    methods: {
        ...
        async getData(datas){
            ...
            setTimeout(()=>{
              this.showLengt>30? document.querySelector('.decial-3-history').scrollLeft=9000: document.querySelector('.decial-3-history').scrollLeft=0;
            })
        ...
        lastDataFc(){
            ...
            this.datas.datasTotal.forEach((item,v)=>{
                ...
                if(v==this.datas.datasTotal.length-1){
                    ...
                    if(lastDataLength<29){
                        for(let j=1;j<=29-lastDataLength+10;j++){
                          recieveForWard.push({list:[{},{},{},{},{},{},{},{}]});
                        }        
                    }else if(lastDataLength>=29){
                        for(let j=1;j<=10;j++){
                          recieveForWard.push({list:[{},{},{},{},{},{},{},{}]});
                        }  
                    }
