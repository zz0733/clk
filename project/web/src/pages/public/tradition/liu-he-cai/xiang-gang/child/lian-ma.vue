    ...
    <div class="lottery-content-all-wrap">
        <form ref="formDynamic">
                        ...
                        <div class="all-item">
                            <el-checkbox-group v-model="checkList">
                                <div :key="indexInner" v-for="(itemInner,indexInner) in itemOut.mess" class="box lian-ma-cheacBox">
                                    ...
                                    <el-checkbox @click.native.stop="''" @change="checkboxChange($event,itemInner)" :disabled="itemInner.disabled" :label="itemInner"></el-checkbox>
                                </div>
                            </el-checkbox-group>
                        </div>
                    ...
                    <div class="zheng-ma-footer-left">
                        <el-radio-group v-model="footer.model">
                            <div :key="index" v-for="(item,index) in footer.list">
                                <el-radio v-if="navigation.navSelect=='三全中'||navigation.navSelect=='三中二'||navigation.navSelect=='四中一'?index<2:index>-1" :disabled="disabledRadio" @change="radioChange(item)" :label="item.label">{{item.label}}</el-radio>
                            </div>
                        </el-radio-group>
                    </div>
                        ...
                        <tr>
                            <el-radio-group v-model="footerAnima.modelT">
                                <td :key="index" v-for="(item,index) in footerAnima.radioArrT">
                                    <el-radio @change="getAnimaNum(item,'TOP')" :label="item.title" :disabled="footerAnima.disabledT">{{item.title}}</el-radio>
                                </td>
                            </el-radio-group>
                        </tr>
                        <tr>
                            <el-radio-group v-model="footerAnima.modelB">
                                <td :key="index" v-for="(item,index) in footerAnima.radioArrB">
                                    <el-radio @change="getAnimaNum(item,'BOT')" :label="item.title" :disabled="footerAnima.disabledB">{{item.title}}</el-radio>
                                </td>
                            </el-radio-group>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <el-radio-group v-model="footerTail.modelT">
                                <td :key="index" v-for="(item,index) in footerTail.radioArrT">
                                    <el-radio @change="footerTailChange(item,'TOP')" :label="item.title" :disabled="footerTail.disabledT">{{item.title}}</el-radio>
                                </td>
                            </el-radio-group>
                        </tr>
                        <tr>
                            <el-radio-group v-model="footerTail.modelB">
                                <td :key="index" v-for="(item,index) in footerTail.radioArrB">
                                    <el-radio @change="footerTailChange(item,'BOT')" :label="item.title" :disabled="footerTail.disabledB">{{item.title}}</el-radio>
                                </td>
                            </el-radio-group>
                        </tr>
                    </table>
            ...
            <div class="lottery-content-all-right">
                <vp-fast-and-submit v-on:range-say="rangeChange" v-on:submit-Input-say="fastInput" v-on:submit-resetAll="resetAll" v-on:submit-review="review" :totalCount="totalCount" :selectFast="selectFast" :saveSelectMoney="saveSelectMoney" :rangleType="rangleType">
                </vp-fast-and-submit>
            </div>
        </form>
    ...
    async submit(){
      ...
      this.submitList.forEach((item)=>{
          ...
          if(this.footer.model=="胆拖"){
                ...
                submitArr.push({"code":item.ball,"playway":item.code,"odds":item.price,"money":finalModel,"ball":item.title,"attach":dTARR.join()})
          }else if(this.footer.model=="生肖对碰"){
               submitArr=[{"code":this.footerAnima.modelT,"playway":item.code,"odds":item.price,"money":finalModel,"ball":item.title,"attach":""},{"code":this.footerAnima.modelB,"playway":item.code,"odds":item.price,"money":this.saveSelectMoney.money,"ball":item.title,"attach":""}]
          }else if(this.footer.model=="尾数对碰"){
               submitArr=[{"code":this.footerTail.modelT,"playway":item.code,"odds":item.price,"money":finalModel,"ball":item.title,"attach":""},{"code":this.footerTail.modelB,"playway":item.code,"odds":item.price,"money":this.saveSelectMoney.money,"ball":item.title,"attach":""}]
          }else if(this.footer.model=="肖串尾"){
               submitArr=[{"code":this.footerAnima.modelT,"playway":item.code,"odds":item.price,"money":finalModel,"ball":item.title,"attach":""},{"code":this.footerTail.modelT,"playway":item.code,"odds":item.price,"money":this.saveSelectMoney.money,"ball":item.title,"attach":""}]
          }else{
                submitArr.push({"code":item.ball,"playway":item.code,"odds":item.price,"money":finalModel,"ball":item.title,"attach":""})
          }
      })
      // console.log(this.submitList)
