  ...
  <div class="container">
    ...
    <div class="cp-container-wrap">
        ...
        <transition name="fade" mode="out-in"> 
          <vp-ku-zhi-xuan ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='直选'"></vp-ku-zhi-xuan>
          <vp-ku-dian-shu ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='点数'"></vp-ku-dian-shu> 
          <vp-san-tong ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='三同'"></vp-san-tong>
          <vp-san-bu-tong ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='三不同'"></vp-san-bu-tong> 
          <vp-er-tong ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='二同'"></vp-er-tong>
          <vp-er-bu-tong ref="content"   :oddsListPar="oddsListPar"   :isopen="isopen" :childNeedMess="childNeedMess" v-if="this.navObj.model=='二不同'"></vp-er-bu-tong> 
        </transition>
    </div>
