                    ...
                    <div :key="indexInner" v-for="(itemInner,indexInner) in recommendList" class="home-content-item">
                        <div class="box-top">
                            ...
                            <div class="box-top-right">
                                ...
                                <p>第
                                    <span>&nbsp;{{itemInner.lotteryId==2||itemInner.lotteryId==10||itemInner.lotteryId==1?itemInner.issue:itemInner.issue.toString().substring(4,itemInner.issue.length)}}&nbsp;</span> 期</p>
                            ...
                            <div v-if="itemInner.lastresultInfo" class="box-mid-right" :class="{
                              ...
                              ||itemInner.lotteryId=='29'                              
                                ...
                                <span class="lotterySpan">
                                    <span class="ballOuside" :key="indexThir" v-for="(itemThir,indexThir) in itemInner.list">
                                        <span :class="{
                        ...
                        <div class="box-bot">
                            ...
                            <a v-if="itemInner.djs_next_kaipan || itemInner.djs_fengpan <0 &&itemInner.lotteryId == 1 "   :href="itemInner.router" class="item bg-primary">已封盘</a>
    ...
    return {
      ...
      lotteryDatas:[
       {title:'row1',
          rowList:[
            //六合彩
            {"name":"香港六合彩","lotyId":1,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"快速六合彩","lotyId":18,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"5分六合彩","lotyId":19,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            //时时彩
            {"name":"重庆时时彩","lotyId":4,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"天津时时彩","lotyId":15,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"新疆时时彩","lotyId":14,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},            
            {"name":"快速时时彩","lotyId":16,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"3分时时彩","lotyId":17,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},            
            //pk10
            {"name":"快速赛车","lotyId":12,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"3分赛车","lotyId":13,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"北京赛车","lotyId":2,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            {"name":"幸运飞艇","lotyId":3,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},
            //pc蛋蛋
            {"name":"PC蛋蛋","lotyId":10,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''}]},                       
            //快三
            {"name":"江苏快3","lotyId":9,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},           
            {"name":"安徽快3","lotyId":25,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},                     
            {"name":"吉林快3","lotyId":26,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},            
            {"name":"快速快3","lotyId":27,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]}, 
            
            {"name":"北京快3","lotyId":2900,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},           
            {"name":"甘肃快3","lotyId":2901,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},                     
            {"name":"广西快3","lotyId":2902,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},            
            {"name":"贵州快3","lotyId":2903,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},              
            {"name":"河北快3","lotyId":2904,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},            
            {"name":"湖北快3","lotyId":2905,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},             
            {"name":"上海快3","lotyId":2906,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:'',class:''},{ball:'',class:''},{ball:'',class:''}]},           
          //11选5
            {"name":"广东11选5","lotyId":7,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"江西11选5","lotyId":21,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"山东11选5","lotyId":23,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"快速11选5","lotyId":24,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"上海11选5","lotyId":22,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            //快乐十分
            {"name":"广东快乐十分","lotyId":5,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"湖南快乐十分","lotyId":20,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            //低频彩
            {"name":"幸运农场","lotyId":6,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''},{ball:''}]},          
            {"name":"上海时时乐","lotyId":29,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''}]},          
            {"name":"福彩3D","lotyId":11,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''}]},          
            {"name":"排列3","lotyId":28,"djs_fengpan":0,"djs_next_kaipan":0,"issue":"","id":"","list":[{ball:''},{ball:''},{ball:''}]},          
          ]
       }        
      ],
      recommendList:''
