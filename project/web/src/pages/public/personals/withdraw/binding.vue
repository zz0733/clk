  ...
  <div class="content clearfloat">
    ...
    <div class="deposit-left fl">
      <div class="row">
        ...
        <input type="text" v-model="cardName" maxlength="15" v-if="!this.$store.state.mainState.userinfo.realName">
    ...
    <div class="deposit-right fl">
      ...
      <div v-else style='margin:100px 0;text-align:center;'><img src='/static/public/image/userImg/no-data.png' alt=''></div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    setBank() {
      ...
      if (!this.value && !this.$store.state.mainState.userinfo.secret) {
      ...
      if (this.$store.state.mainState.userinfo.payPassword == "noset") {
      ...
      this.$http.post(`${this.$HOST_NAME}/member/setBank`, param).then(res => {
        if (res.code == 200) {
          this.$success("绑定成功");
          this.userBank();
          this.payPassword = "";
