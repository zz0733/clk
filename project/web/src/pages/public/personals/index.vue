  ...
  <div class="peronsals">
    <div class="peronsals-content">
      ...
      <div class="loading" v-if="loadingShow">
        <p>数据加载中...</p>
        <svg xmlns="http://www.w3.org/2000/svg" class="waves" width="1366" height="312" viewBox="0 24 150 28" preserveAspectRatio="none">
            <defs>
              <path id="wave-taHGs" d="m -160,44.4 c 30,0 58,-18 87.7,-18 30.3,0 58.3,18 87.3,18 30,0 58,-18 88,-18 30,0 58,18 88,18 l 0,34.5 -351,0 z"></path>
...
// 投注记录
import personage1 from "./personage/bet.vue";
// 存款记录
...
import withdraw1 from "./withdraw/record";
import withdraw2 from "./withdraw/binding";
// 代理
import agency0 from "./agency/agency_index";
import agency1 from "./agency/agency_finance";
import agency2 from "./agency/agency-team";
import agency3 from "./agency/agency_link";
import agency4 from "./agency/agency_open";
// 消息
...
import discounts1 from "./discounts/self_help";
export default {
  data() {
    return {
      comPName: 'recharge0'
