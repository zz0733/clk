<template>
  <div class="preferential">
    ...
    <div class="content clearfloat" v-if="messageData.length">
      ...
      <sent-right class="fr right" :messageDetail="messageDetail" :receivedText="receivedText" :flag="flag"></sent-right>
    </div>

    <div v-else style='margin:100px 0;text-align:center;'><img src='/static/public/image/userImg/no-message.png' alt=''></div>
  </div>
