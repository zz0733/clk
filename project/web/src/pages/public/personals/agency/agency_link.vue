...
<div class="agency-link" v-if="linkShow">
  ...
  <div class="search">
    ...
    <DatePicker type="daterange" placement="bottom-end" placeholder="选择时间" style="width: 236px;margin-left:25px;"></DatePicker>
    <div class="searchBtn" @click="getDomains">搜索</div>
  </div>
  <!-- 链接内容 -->
  <div class="link-content">
    <Table :columns="columns" :data="domianData" no-data-text="<div style='margin:100px 0;'><img src='/static/public/image/userImg/no-data.png' alt=''></div>"></Table>
