<template>
  <div class="live">
    ...
    <div id="main"> 
      ...
      <div id="box">
        <ul id="slider">
          <li :key="index" v-for="(item,index) in liveDatas" href="javascript:void(0)"  @click="getItemId(item)">{{item.name}}</li>
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      key: "",
      liveDatas: [
        {name:'AG视讯厅',platform: 'live_casino',id:'14',class:'ag'},
        {name:'BBIN视讯厅',platform: 'live_casino',id:'15',class:'bb'},
        {name:'BG视讯厅',platform: 'live_casino',id:'44',class:'bg'},
        {name:'DG视讯厅',platform: 'live_casino',id:'33',class:'dg'},
        {name:'DS视讯厅',platform: 'live_casino',id:'16',class:'ds'},
        {name:'LEBO视讯厅',platform: 'live_casino',id:'35',class:'lebo'},
        {name:'OG视讯厅',platform: 'live_casino',id:'39',class:'og'},
        {name:'eBET视讯厅',platform: 'live_casino',id:'34',class:'ebet'},
        {name:'LMG视讯厅',platform: 'live_casino',id:'36',class:'lmg'},
        {name:'欧博视讯厅',platform: 'live_casino',id:'37',class:'ob'},
        {name:'SA视讯厅',platform: 'live_casino',id:'40',class:'sa'}       
      ]
    };
  },
  methods: {
