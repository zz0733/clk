          ...
          <div class="live-entertainment">
            <div class="header">
              ...
              <ul class="type" @mouseleave="liveLeave">
                <li @click="getItemId(item)"  @mouseenter="liveEnter(item)"  :key='index' v-for="(item,index) in optionList" :class="{'active':setting.live.liveVal==item.index}">
                  <a  href="javascript:void(0)">{{item.name}}</a>
                </li>
              </ul>            
            </div>
            <Carousel v-model="setting.live.liveVal" :autoplay="setting.live.autoplay" :autoplay-speed="setting.live.autoplaySpeed" :dots="setting.live.dots" :trigger="setting.live.trigger" :arrow="setting.live.arrow">
              ...
              <li class="item" v-for="(item,i) in otherGame" :key="i" >
                ...
                <div class="cont-wrap">
                  ...
                  <div v-if="i==1" class="amount">
                        <h1>老虎机总彩池</h1>
                        <div class="jp_">
                          <h2> CNY {{jackpotNum.toString().substring(0,3)}},{{jackpotNum.toString().substring(3,6)}},{{jackpotNum.toString().substring(6,9)}}.{{jackpotNum.toString().substring(9,11)}}</h2>
                        </div>
                  </div>   
