    ...
    <div class="bar-right">
      <div class="fright">
        <div class="top_bar">
          ...
          <a href="#/home/contactUs/1">帮助信息</a> <span v-if="userinfo">|</span>
          <a href="javascript:'" @click="goUserCen('agency',0)" class="bar_mobile" v-if="userinfo">代理加盟</a>
        </div>
        <div class="area-wrap">
          <div class="login-area log-after clear" v-if="userinfo">
            <div class="preson-info clear">
              <span class="info acc-person">
                  <strong class="account_hidden">账号:</strong><span class="value account_name">{{userinfo&&userinfo.userName}}</span>
              </span>
              <span class="info acc-balance">
                  <strong>余额:</strong>
                  <span class="value">{{userinfo&&userinfo.balance}}</span>
                  <div class="luck-icon" style="display:inline-block; margin-top: -9px; background-image: none;">
                      <span style="width:20px; display:block; padding-top:2px; float:none;">
                          <a href="javascript:void(0)" @click="getBalance()" style="display: inline-block; width: 16px; height: 16px; margin-top: 0px; background: url('/static/test/img/refresh.png')"> </a>
                      </span>
                  </div>
              </span>
            </div>
            <div class="acc-links">
              <a title="会员中心" class="btn btn-navacc-member" href="javascript:void(0);" @click="goUserCen('personage',0)">会员中心</a>
              <a title="在线存款" class="btn btn-navacc-deposit" href="javascript:void(0);" @click="goUserCen('recharge',0)">充值</a>
              <a title="在线取款" class="btn btn-navacc-withdraw" href="javascript:void(0);" @click="goUserCen('withdraw',0)">提款</a>
              <a title="退出" class="btn btn-login-out" href="javascript:void(0);" @click="logout"><span>退出</span></a>
            </div>
          </div>
            ...
            <div class="login-area clear">
              <div class="area-left">
                  <span class="login-mane">
                      <input class="input_tip" id='userName' type="text" size="12" v-model="passKey.userName" title="请填写 4-12 位大小写英数字" maxlength="12" placeholder="会员账号" tabindex="1" required="">
                  </span>
                  <span class="login-code">
                      <input type="text" class="input_tip input_tip_45" size="7" maxlength="4" title="( 点击此处产生新验证码 )" v-model="passKey.code" @keyup.13="login" placeholder="验证码" @focus="getCode" style="width: 45px;">
                  </span>
                  <img title="点击切换验证码" width="62" height="24" :src="codeImg" @click="getCode" style="background-color:white;" alt="验证码">
                  <span class="login-password">
                      <input class="input_tip" type="password" v-model="passKey.password" @keyup.13="login" autocomplete="off" size="13" maxlength="12" title="请填写 6-12 位大小写英数字" placeholder="登录密码" tabindex="2" required="">
                  </span>
                  <a title="登录" href="javascript:void(0)" @click="login" class="btn-login" style="position:relative">
                      <span>登录</span>
                  </a>
                  <a title="忘记密码" :href="$root.config.service[0]&&$root.config.service[0].url" target="_blank" class="btn-member">忘记密码</a>
              </div>
          ...
          <div class="menu" style="margin-left: -12px;">
              <ul class="clear" style="width: 1020px;">
                  ...
                  <li class="officialLottery">
                      <a href="javascript:void(0);" class="lottery" @click="goTo({type:'lottery',router:'#/plays/hall'});">
                                ...
                                <div class="high_wrap">
                                    <div class="gamelist_r">
                                        <div class="items" style="width: 490px;">
                                            <div class="item">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/16'});">
                                                    <img src="/static/test/img/logo/ksssc.png">
                                                    <p class="hot"><font>快速时时彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico"  @click="goTo({type:'lottery',router:'#/plays/tradition/17'});">
                                                    <img src="/static/test/img/logo/sfssc.png">
                                                    <p class="hot"><font>三分时时彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/4'});">
                                                    <img src="/static/test/img/logo/gf_a1.png">
                                                    <p class="hot"><font>重庆时时彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/12'});">
                                                    <img src="/static/test/img/logo/kssc.png">
                                                    <p class="hot"><font>快速赛车</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/13'});">
                                                    <img src="/static/test/img/logo/sfsc.png">
                                                    <p class="hot"><font>三分赛车</font></p>
                                                </div>
                                            </div>
                                            <div class="item" style="margin-left: 14px;">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/2'});">
                                                    <img src="/static/test/img/logo/gf_a3.png">
                                                    <p class="hot"><font>北京PK拾</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/3'});">
                                                    <img src="/static/test/img/logo/XYFT.png">
                                                    <p class="hot"><font>幸运飞艇</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <img class="hot_tag" src="/static/test/img/hot_icon/1.gif">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/18'});">
                                                    <img src="/static/test/img/logo/kslhc.png">
                                                    <p class="hot"><font>快速六合彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/1'});">
                                                    <img src="/static/test/img/logo/xy_a1.png">
                                                    <p class="hot"><font>香港六合彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/5'});">
                                                    <img src="/static/test/img/logo/xy_a2.png">
                                                    <p class="hot"><font>广东快乐10分</font></p>
                                                </div>
                                            </div>
                                            <div class="item" style="margin-left: 14px;">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/6'});">
                                                    <img src="/static/test/img/logo/xync.png">
                                                    <p class="hot"><font>幸运农场</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/7'});">
                                                    <img src="/static/test/img/logo/GD11X5.png">
                                                    <p class="hot"><font>广东11选5</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/15'});">
                                                    <img src="/static/test/img/logo/gf_a9.png">
                                                    <p class="hot"><font>天津时时彩</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/29'});">
                                                    <img src="/static/test/img/logo/xy_a11.png">
                                                    <p class="hot"><font>上海时时乐</font></p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="item-ico" @click="goTo({type:'lottery',router:'#/plays/tradition/9'});">
                                                    <img src="/static/test/img/logo/gf_a6.png">
                  ...
                  <li class="vrLottery">
                      <a href="javascript:void(0);" class="UserCenter" @click="getItemId({id: '13',platform: 'vr_lottery'});">
                          <div class="xdl-usercenter-divPL" style="padding-left: 0!important;">
                              VR彩票<br>
                              <span style="font-size: 9px;">VRLOTTERY</span>
                          </div>
                      </a>
                      <!--
                  ...
                  <li>
                      <a href="javascript:void(0);" class="Activity" data-item="ig_hall" @click="goTo({router:'/home/qipai'})">
                  ...
                  <li>
                      <a href="javascript:void(0);" class="Activity" @click="goTo({router:'/home/games?id=26&name=MG老虎机'})">
                          <!--                                    <i class="menu-icon icon3"></i>-->
                          <div>
                              电子游艺<br>
                  ...
                  <li>
                      <a href="javascript:void(0);" class="Activity" @click="goTo({router:'/home/buyu'})">
                          <div>
                              捕鱼游戏<br>
                  ...
                  <li>
                      <a href="javascript:void(0)" class="Activity" @click="goTo({router:'/home/live'})">
                          <!--                                    <i class="menu-icon icon3"></i>-->
                          <div>
                              真人视讯<br>
                  ...
                  <li>
                      <a href="javascript:void(0);" class="mobile" @click="goTo({router:'/home/youhui'})">
                          <!--                                    <i class="menu-icon icon7"></i>-->
                          <div>
                              优惠活动<br>
                              <span style="font-size: 9px; margin-left: -15px;">ACTIVITY</span>
                          </div>
                      </a>
                  </li>
                  <li>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      this.$http.post(`${this.$HOST_NAME}/login`, this.passKey).then(res => {
        if (res.code == 200) {
          ...
          this.$Modal.error({
              title: '登录提示',
              content: '<font size="2.5">'+res.message+'</font>'
          });
        }
      });
    },
    ...
    setIndex(){
      var content = '<font size="2.5">抱歉，您所使用的浏览器无法完成此操作。您需要手动将【'+this.$root.currentDomain+'】设置为首页，<br>请参考<a style="color:#57a3f3;" href="http://www.baidu.com/cache/sethelp/index.html" target="_blank">如何设为首页</a></font>';
      this.$Modal.info({
          title: '设为首页提示',
          content: content
      });
    ...
    addCollect(){
      this.$Modal.info({
          title: '加入收藏提示',
          content: '<font size="2.5">抱歉，您所使用的浏览器无法完成此操作。<br>加入收藏失败，<br>电脑请使用Ctrl+D进行添加</font>'
      });
    },
    async tryPlay() {
