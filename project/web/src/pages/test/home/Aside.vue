<template>
  <div>
    <a v-show="false" href="/static/test/html/active/opportunity/index.html" target="_blank" style="position: fixed; z-index: 1001; left: 0; bottom: 0;">
      ...
      <img src="/static/test/img/hc_zhuanpan.gif" alt="幸运转盘">
  </a>
    <ul v-show="s1" class="TplFloatSet0 TplFloatSet TplFloatPic_1">
      <span class="kefuw-left-01"></span>
      <span class="kefuw-left-02">
        <a href="/static/test/html/active/jgj/index.html" target="_blank" class="mobdm"></a>
      </span>
      <span class="kefuw-left-03">
        <a href="/static/test/html/active/opportunity/index.html" target="_blank" class="mobdm"></a>
    </span>
...
.TplFloatSet {
  ...
  top: 180px;
  right: 10px;
  background: url(/static/test/img/kefuw-right.png) no-repeat;
  z-index: 1000;
  .kefuw-tit{
    display: block;
    width: 100%;
...
.TplFloatSet0 {
  ...
  left: 10px;
  z-index: 1000;
  background: url(/static/test/img/kefuw-left.png) no-repeat;
  .kefuw-left-01{
    display: block;
    height: 64px;
