                   ...
                   <ul>
                      <li v-for="(item,i) in buyuData" :key="i">
                        <div class="cover_hover"></div>
                         ...
                         <p ><a class="btn" @click="trustLogin({platform:item.platform,gameName:item.gameName,name:'开元棋牌'})">开始游戏</a></p>
                         <p> <a class="btn_ag" @click="trustLogin({platform:item.platform,gameName:item.gameName,name:'开元棋牌'})" href="javascript:void(0)">游戏说明</a>
				</p>
                      </li>
  ...
  data() {
    return {
      buyuData: [
        // {
        //   name: "mw棋牌",
        //   img: require("/static/hsyl/img/chess1.png"),
        //   content: "花式捕鱼 爽快捞金",
        //   platform: "MW_GAME",
        //   gameName: "0"
        // },
        {
          name: "开元棋牌",
          img: "/static/hsyl/img/chess2.png",
          content: "经典玩法 玩法丰富",
          platform: "KY_CHESS",
          gameName: "0"
        }
...
.fishing_main {
  ...
  height: 900px;
  background: url("/static/hsyl/img/chess_bg.jpg") center top;
