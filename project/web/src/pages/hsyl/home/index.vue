                        ...
                        <li>
                            <div class="wrap" :key="intIndex" v-for="(intItem,intIndex) in outItem.list" >
                                ...
                                <div class="rule">
                                    ...
                                    <div @click="$router.push({path:intItem.router});$store.commit('hsyl/setNav', 1)">立即投注</div>
                                </div>
						    </div>                          
                        </li>
                    </ul>
                    ...
                    <div class="left-wrap" :class="[hotNow.class]">
                        ...
                        <div class="content">
                            <div class="c1">
                                ...
                                <a v-if="hotNow.btn" @click="$router.push({path:hotNow.btn[0].router});$store.commit('hsyl/setNav', 1);"  class="link_btn">{{hotNow.btn[0].name}}</a>
                            </div>
                        </div>
  ...
  data() {
    ...
    //   @click="goto({'path':`/rules/${$route.meta.series}`,query:{id:$route.meta.id}})"
      lotteryList:[
          {
            list:[
                {name:'北京赛车',router:'/plays/tradition/2',ico:'/static/hsyl/img/home/icon1.png',rulePath:'/rules/pk10',id:2},
                {name:'快乐十分',router:'/plays/tradition/5',ico:'/static/hsyl/img/home/icon2.png',rulePath:'/rules/klsf',id:5},
                {name:'重庆时时彩',router:'/plays/tradition/4',ico:'/static/hsyl/img/home/icon3.png',rulePath:'/rules/ssc',id:4}
            ] 
          },
          {
            list:[
                {name:'幸运飞艇',router:'/plays/tradition/3',ico:'/static/hsyl/img/home/xyft.png',rulePath:'/rules/pk10',id:3},
                {name:'六合彩',router:'/plays/tradition/1',ico:'/static/hsyl/img/home/66666666.png',rulePath:'/rules/lhc',id:1},
                {name:'11选5',router:'/plays/tradition/7',ico:'/static/hsyl/img/home/11-5.png',rulePath:'/rules/cp11x5',id:7}
            ] 
          },
          {
            list:[
                {name:'快速六合',router:'/plays/tradition/18',ico:'/static/hsyl/img/home/jslh.png',rulePath:'/rules/lhc',id:18},
                {name:'快速赛车',router:'/plays/tradition/12',ico:'/static/hsyl/img/home/jssc.png',rulePath:'/rules/pk10',id:12},
                {name:'快速时时彩',router:'/plays/tradition/16',ico:'/static/hsyl/img/home/jsssc.png',rulePath:'/rules/ssc',id:16}
            ] 
          },                    
      ],
      //热门游戏
      hostList:[
        {img:'/static/hsyl/img/home/cai.png',name:'传统彩票',class:'active1',
            title:'传统彩票',
            text:'全面覆盖重庆时时彩、北京赛、PK10等，并提供香港六合彩的各期开奖信息，为广大喜爱玩港彩的用户及时的开奖信息。',
      ...
      hotNow:{img:'/static/hsyl/img/home/cai.png',name:'传统彩票',class:'active1',
       title:'传统彩票',
