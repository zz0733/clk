    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="group">
          ...
          <input type="text" placeholder="请输入6到10位的数字或字母组合" maxlength="16" v-model="userName" @blur="getCode">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="group">
          ...
          <input type="password" placeholder="请输入6到10位的数字或字母组合" maxlength="16" v-model="password">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="group">
          ...
          <input type="password" placeholder="请输入6到10位的数字或字母组合" maxlength="16" v-model="register_password">
        </div>
      </div>
...
.register {
  ...
  .popup {
    ...
    .headline {
      ...
      background: url("/static/hsyl/img/bg_reg_title.png");
      p {
        font-size: 24px;
        color: #fff;
        position: absolute;
