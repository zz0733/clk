...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/hsyl/index.vue')), 'index');
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/hsyl/home')), 'vpHome');

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/hsyl/home/home-live')), 'vpHomeLive');
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/hsyl/home/home-contactUs')), 'vpHomeContactUs');
const vpGames = r => require.ensure([], () => r(require('@/pages/hsyl/home/games')), 'vpGames');
const vpBuyu = r => require.ensure([], () => r(require('@/pages/hsyl/home/buyu')), 'vpBuyu');
const vpYouhui = r => require.ensure([], () => r(require('@/pages/hsyl/home/youhui')), 'vpYouhui');
const vpQipai = r => require.ensure([], () => r(require('@/pages/hsyl/home/qipai')), 'vpQipai');
const vpTiyu = r => require.ensure([], () => r(require('@/pages/hsyl/home/tiyu')), 'vpTiyu');
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading');
const clause = r => require.ensure([], () => r(require('@/pages/hsyl/home/clause')), 'clause');
