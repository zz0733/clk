...
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/ecp/home')), 'vpHome');

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/ecp/home/home-live')), 'vpHomeLive');
const vpGames = r => require.ensure([], () => r(require('@/pages/ecp/home/games')), 'vpGames');
const vpBuyu = r => require.ensure([], () => r(require('@/pages/ecp/home/buyu')), 'vpBuyu');
const vpYouhui = r => require.ensure([], () => r(require('@/pages/ecp/home/youhui')), 'vpYouhui');
const vpChess = r => require.ensure([], () => r(require('@/pages/ecp/home/chess')), 'vpChess');
const vpSport = r => require.ensure([], () => r(require('@/pages/ecp/home/sport')), 'vpSport');
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading');
const register = r => require.ensure([], () => r(require('@/pages/ecp/home/register')), 'register');
const clause = r => require.ensure([], () => r(require('@/pages/ecp/home/clause')), 'clause');


// 帮助
const vpHomeHelp = r => require.ensure([], () => r(require('@/pages/ecp/home/help')), 'vpHomeHelp');
