                   ...
                   <ul>
                      <li v-for="(item,i) in buyuData" :key="i">
                        <div class="cover_hover"></div>
                         ...
                         <p ><a class="btn" @click="trustLogin({name:item.name,platform:item.platform,gameName:item.gameName})">开始游戏</a></p>
                         <p> <a class="btn_ag" @click="trustLogin({name:item.name,platform:item.platform,gameName:item.gameName})" href="javascript:void(0)">游戏说明</a>
				</p>
                      </li>
