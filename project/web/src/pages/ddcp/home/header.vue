        ...
        <div class="linkbar clearfix">
          ...
          <div class="link fr">
            <ul class="clearfix">
              ...
              <li><a href="#/home/question">防劫持教程</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="loginBox">
          ...
          <div class="user">
            ...
            <ul class="snavInfo" v-if="!userinfo">
              <li>
                <input type="text" placeholder="请输入用户名" autocomplete="off" class="userInput" v-model="passKey.userName" @blur="getCode">
              </li>
              <li>
                <input type="password" placeholder="请输入密码" autocomplete="off" class="userInput" v-model="passKey.password">
              </li>
              <li>
            ...
            <ul class="snavInfo" v-else>
              ...
              <li>
                <a class="ServiceBtn" href="https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=918068&configID=41397&jid=8004026909&s=1" target="_blank"></a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="nav">
      <div class="container clearfix">
        <div class="hotGame fl">
              ...
              <div class="subWrapper clearfix">
                <div class="sub fl" v-for="(game,i) in hotGames.officialGames" :key="i">
                  <a :href="game.router" target="_blank">
                    <div style="text-align: center;"><img :src="game.icon" alt=""></div>
          ...
          <li v-for="(nav,i) in navList" :key="i" :ref="'item'+i" class="item" :class="{navActive:navActive ==i}" @click.stop="toggleNav(i,nav.router)">
            ...
            <div class="sub-nav clearfix" v-if="nav.child">
              <div class="sub" v-for="(subitem,i) in nav.child" :key="i" @click.stop="goThirdParty(subitem,nav.platform)">
    ...
    return {
      ...
      hotGames: {
        officialGames: [
          {
            name: "江苏快三",
            icon: "/static/ddcp/img/lottery/vp-9.png",
            router: "#/plays/tradition/1"
          },
          {
            name: "北京赛车",
            icon: "/static/ddcp/img/lottery/vp-2.png",
            router: "#/plays/tradition/2"
          },
          {
            name: "快速赛车",
            icon: "/static/ddcp/img/lottery/vp-12.png",
            router: "#/plays/tradition/12"
          },
          {
            name: "重庆时时彩",
            icon: "/static/ddcp/img/lottery/vp-4.png",
            router: "#/plays/tradition/4"
          },
          {
            name: "快速时时彩",
            icon: "/static/ddcp/img/lottery/vp-16.png",
            router: "#/plays/tradition/16"
          },
          {
            name: "香港六合彩",
            icon: "/static/ddcp/img/lottery/vp-1.png",
            router: "#/plays/tradition/1"
          },
          {
            name: "快速六合彩",
            icon: "/static/ddcp/img/lottery/vp-18.png",
            router: "#/plays/tradition/18"
          },
          {
            name: "幸运飞艇",
            icon: "/static/ddcp/img/lottery/vp-3.png",
            router: "#/plays/tradition/3"
          },
          {
            name: "3分赛车",
            icon: "/static/ddcp/img/lottery/vp-13.png",
            router: "#/plays/tradition/13"
          },
          {
            name: "3分时时彩",
            icon: "/static/ddcp/img/lottery/vp-17.png",
            router: "#/plays/tradition/17"
          },
          {
            name: "5分六合彩",
            icon: "/static/ddcp/img/lottery/vp-19.png",
            router: "#/plays/tradition/19"
          },
          {
            name: "PC蛋蛋",
            icon: "/static/ddcp/img/lottery/vp-10.png",
            router: "#/plays/tradition/10"
          },
          {
            name: "广东11选5",
            icon: "/static/ddcp/img/lottery/vp-7.png",
            router: "#/plays/tradition/7"
          },
          {
            name: "广东快乐十分",
            icon: "/static/ddcp/img/lottery/vp-5.png",
            router: "#/plays/tradition/5"
          },
          {
            name: "幸运农场",
            icon: "/static/ddcp/img/lottery/vp-6.png",
