    ...
    <div class="container clearfloat">
      ...
      <div class="wrapL">
        ...
        <ul class="subnav bottom">
          <li v-for="(item,key) in wraplCtData" :key="key" class="clearfix">
            ...
            <div class="fr initemWrapper clearfix">
              <a class="fl" v-for="(initem,i) in item.children" :key="i" :href="initem.router" target="_blank">
                {{initem.name}}
              </a>
            </div>
              ...
              <div class="paths">
                <ul class="clearfix">
                  <li class="fl" v-for="(link,i) in item.links.paths" :key="i">
                    <a :href="link.router" target="_blank">{{link.name}}</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="palyerGuide">
          <h6 class="clearfix"><span class="fl">新手指引</span> <a class="fr" href="#/home/help" target="_blank">更多>></a></h6>
      ...
      <div class="wrapR fr">
        <div class="top clearfix">
          <div class="banner fl">
            <el-carousel :interval="2000" arrow="never" height="225px">
          ...
          <div class="appCode fr">
            ...
            <div class="wrapper">
              <div v-show="isCode=='ios'" class="ios">
                <img src="/static/ddcp/img/ios.png" alt="">
              </div>
              <div v-show="isCode=='android'" class="android">
                <img src="/static/ddcp/img/android.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="autoTab clearfix">
          <div class="left fl">
            <ul class="hd clearfloat">
              <li :class="{on:hdActive==0}" @click="getResult({name:'kslhc',id:18});hdActive=0">快速六合彩</li>
              <li :class="{on:hdActive==1}" @click="getResult({name:'kssc',id:12});hdActive=1">快速赛车</li>
              <li :class="{on:hdActive==2}" @click="getResult({name:'cqssc',id:4});hdActive=2">重庆时时彩</li>
              <li :class="{on:hdActive==3}" @click="getResult({name:'sh11x5',id:22});hdActive=3">上海11选5</li>
              <li :class="{on:hdActive==4}" @click="getResult({name:'sfssc',id:17});hdActive=4">三分时时彩</li>
            </ul>
            ...
            <div class="bd clearfix">
              ...
              <div class="right fl">
                <div class="result">
                  ...
                  <div class="btn">
                    <a :href="allReData.router||'#/plays/tradition/18'" target="_blank" class="mainColorBtn">立即投注</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="lives">
          <div class="wrapper clearfix">
            <div class="liveItem" v-for="(item,i) in lives" :key="i" @click="goThirdParty(item)">
...
export default {
  ...
  data() {
    return {
      ...
      lives: [
        {
          name: "ag",
          src: "/static/ddcp/img/live-ag.jpg",
          id: 14,
          platform: "live_casino"
        },
        {
          name: "bbin",
          src: "/static/ddcp/img/live-bbin.jpg",
          id: 15,
          platform: "live_casino"
        },
        ...
        {
          name: "ds",
          src: "/static/ddcp/img/live-ds.jpg",
          id: 16,
          platform: "live_casino"
        }
      ],
      carouselData: [
        { img: "/static/ddcp/img/banner/banner1.png" },
        { img: "/static/ddcp/img/banner/banner2.png" },
        { img: "/static/ddcp/img/banner/banner3.jpg" },
        { img: "/static/ddcp/img/banner/banner4.png" },
        { img: "/static/ddcp/img/banner/banner5.jpg" }
      ],
      hotGames: [
        {
          name: "江苏快3",
          img: "/static/ddcp/img/lottery/vp-9.png",
          router: "#/plays/tradition/9"
        },
        {
          name: "北京赛车",
          img: "/static/ddcp/img/lottery/vp-2.png",
          router: "#/plays/tradition/2"
        },
        {
          name: "重庆时时彩",
          img: "/static/ddcp/img/lottery/vp-4.png",
          router: "#/plays/tradition/4"
        },
        {
          name: "快速时时彩",
          img: "/static/ddcp/img/lottery/vp-16.png",
          router: "#/plays/tradition/16"
        },
        {
          name: "香港六合彩",
          img: "/static/ddcp/img/lottery/vp-1.png",
          router: "#/plays/tradition/1"
        },
        {
          name: "快速六合彩",
          img: "/static/ddcp/img/lottery/vp-18.png",
          router: "#/plays/tradition/18"
        },
        {
          name: "幸运飞艇",
          img: "/static/ddcp/img/lottery/vp-3.png",
          router: "#/plays/tradition/3"
        },
        {
          name: "三分赛车",
          img: "/static/ddcp/img/lottery/vp-13.png",
          router: "#/plays/tradition/13"
        },
        {
          name: "三分时时彩",
          img: "/static/ddcp/img/lottery/vp-17.png",
          router: "#/plays/tradition/17"
        },
        {
          name: "幸运农场",
          img: "/static/ddcp/img/lottery/vp-6.png",
      ...
      wraplData: [
        ...
        {
          img: "/static/ddcp/img/lottery/vp-27.png",
          sortNmae: "一分快3",
          des: "",
          router: "#/plays/tradition/27"
        },
        {
          img: "/static/ddcp/img/lottery/vp-12.png",
          sortNmae: "快速赛车",
          des: "",
      ...
      wraplCtData: [
        ...
        },
        {
          ...
          children: [
            ...
            { name: "极速六合彩", router: "#/plays/tradition/18" },
            { name: "五分六合彩", router: "#/plays/tradition/19" },
            { name: "一分快3", router: "#/plays/tradition/27" }
          ],
          links: {
            name: "快速彩票",
            paths: [
      ...
      if (res && res.code == 200) {
        let config = [
          ...
          },
          {
            name: "sh11x5",
            id: 22,
            router: "#/plays/tradition/22",
            cycle: "每10分钟一期",
            img: "/static/ddcp/img/lottery/vp-22.png",
            rulePath: "#/rules/ssc?id=22",
            trendPath: "#/trend/22"
          },
          {
            name: "sfssc",
  ...
  mounted() {
    this.getResult({ name: "kslhc", id: 18 });
    this.getlantern();
    this.getbannner();
  },
  computed: {
...
@import "../../../assets/less/ddcp/flipclock.css";
...
.new-home {
  padding-bottom: 10px;
  background-image: url(/static/ddcp/img/home_bj.png);
  ...
  .container {
    ...
    .wrapR {
        ...
        .right {
          ...
          .img {
            ...
            i {
              ...
              background: url(/static/ddcp/img/icon/home.fw.png) no-repeat -142px
                6px;
            }
            span {
              vertical-align: middle;
          ...
          .rule {
            ...
            i {
              ...
              width: 32px;
              height: 32px;
              background: url(/static/ddcp/img/icon/home.fw.png) no-repeat;
              line-height: 32px;
              color: #cc0000;
              vertical-align: middle;
            }
      ...
      .lives {
        ...
        margin-top: 10px;
        padding: 11px 0;
        background: url(/static/ddcp/img/livebg.png) repeat;
        .wrapper {
          width: 732px;
          margin: auto;
          cursor: pointer;
          .liveItem {
            ...
            span {
              ...
              padding: 13px 58px;
              display: none;
              background: url(/static/ddcp/img/livebtn-enter.png) no-repeat;
            }
          }
          .liveItem:hover span {
            display: block;
