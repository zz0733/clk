<template>
    <div class="clause">
        <div class="content">
            <div class="logo" style="background-image:none;background-color: #AF221F;text-align: center;">
                <object id="forfun" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="215" height="76" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0">
                    ...
                    <embed id="forfunex" src="/static/dalao/img/logo17.swf" 
                    width="215" height="76" align="middle" 
                    bgcolor="#AF221F" quality="high" menu="false" 
                    play="true" Loop='true' flashvars="" 
                    llowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" style="margin-top: 10px;">
                </object>
            </div>
                <div class="rulesBody">
                    ...
                    <div class="footer">Copyright &copy; 大佬彩票 Reserved</div>
                </div>
            </div>
</template>
<script>
