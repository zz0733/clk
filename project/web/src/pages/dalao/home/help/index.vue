    ...
    <div class="help">
        <div class="wrapper">
            <div :style="{display:$route.params.p_id==1 ? 'block':'none'}" class="page">
                ...
                <div class="article">
                    ...
                    <p>
                        ...
                        如入款账号已过期，大佬彩票恕不负责！万请见谅，感谢配合。<br>
                        <br>
                        4. 核对提交数据/提交申请<br>
                    ...
                    <p>
                        1. 会员登入后点击 【充值】，选择【网银转账】<br>
                        2. 选择入款额度，并请确实填写 ”联络电话” ，如有任何问题，方便大佬彩票客服第一时间与您联系。<br>
                        3. 选择”支付银行”。<br>
                        ...
                        5. 进入网络银行页面，请确实填写您银行账号信息，支付成功，额度将在10分钟内系统处理完成，立即加入您的大佬彩票会员账户。<br>
                        <br>
                        存款需知:<br>
                        大佬彩票最低存款为$10人民币，最高存款无上限!<br>
            ...
            <div :style="{display:$route.params.p_id==2 ? 'block':'none'}" class="page">
                ...
                <div class="article">
                    <p align="left">
                        大佬彩票的客服中心全年无休，提供1周7天、每天24小时的优质服务。</p>
                    <p align="left">
            ...
            <div :style="{display:$route.params.p_id==3 ? 'block':'none'}" class="page">
                ...
                <div class="article">
                    ...
                    <ol>
                        ...
                        <li align="left">大佬彩票保留权利审核会员账户，若由最后一次入款起，有效下注金额需达到入款金额的100%，未达到而申请出款者，公司将收取入款金额的30%行政费用，以及$50出款手续费。</li>
                    </ol>
                    ...
                    <div id="Union">
                        ...
                        <div v-show="tab==1">
                            <p>
                                Q1: 如何加入大佬彩票？</p>
                            <p align="left">
                                A1: 您可以直接点选 立即加入，确实填写资料后，可立即登记成为大佬彩票会员。<br>
                                <br>
                                Q2: 我可以直接在网络上存款吗？<br>
                                A2: 可以，大佬彩票提供多种在线存款选择，详情请参照 存款须知。</p>
                            <p align="left">
                                Q3: 我在那里可以找到游戏的规则？<br>
