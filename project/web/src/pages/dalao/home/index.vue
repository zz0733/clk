      ...
      <div class="newgong">
        <div class="newgong-content">
          <div class="demolist list">
            ...
            <marquee align="middle" direction="left" loop="-1" scrollamount="3" onmouseout="this.start()" onmouseover="this.stop()" style="color: #ffba15; font-size: 15px; line-height: 40px;overflow: hidden;height: 40px;">
              ...
              <div class="header">
                ...
                <ul class="type">
                  <li :key='index' v-for="(item,index) in hotLottery" class="hotlottery">
                    <router-link :to="item.path" class="hotlottery" :class="'hotlottery'+index"></router-link>
                    <router-link :to="item.path" class="txt">{{item.name}}</router-link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <ul class="clearfix">
            <li v-for="lottery in bomLottery" :key="lottery.id" class="fl">
              ...
              <div class="bottom_txt">
                <router-link :to="lottery.path">{{lottery.name}}</router-link>
              </div>
            </li>
          </ul>
        </div>
    ...
    return {
      ...
      bomLottery: [
        ...
        },
        {
          name: "江苏快三",
          path: "/plays/tradition/9",
          icon: "/static/dalao/img/ssc_02.png",
          img: "/static/dalao/img/ic_ul_bg2.jpg",
          id: 9
        },
        {
          name: "重庆时时彩",
          path: "/plays/tradition/4",
          icon: "/static/dalao/img/ssc_01.png",
          img: "/static/dalao/img/ic_ul_bg3.jpg",
          id: 4
        },
        {
          name: "六合彩",
...
.new-index {
  ...
  .dalao-bot-wrap {
    ...
    .content {
      ...
      .content_middle {
        height: 280px;
        background: url(/static/dalao/img/index-downlogo-bg.jpg?2422a3e65a) left
          top no-repeat;
        .btn {
          width: 230px;
          ...
          a {
            ...
            width: 195px;
            height: 70px;
            background: url(/static/dalao/img/index-down-btn.png?016eed19e5)
              left top no-repeat;
            &.ios {
        ...
        .con {
          ...
          h3 {
            width: 100%;
            height: 122px;
            background: url(/static/dalao/img/download-item-tit.png?db2f2f07b1)
              left top no-repeat;
          }
          p {
            width: 100%;
            ...
            height: 25px;
            margin-top: 30px;
            background: url(/static/dalao/img/download-item-con.png?aa97959532)
              left top no-repeat;
          }
        }
      }
