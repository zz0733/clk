...
<div class="wbw-register">
  ...
  <ul class="regMain">
    <li>
      <span>账号：</span>
      <input type="text" autocomplete="off" class="userInput" v-model="userName" @blur="getCode">
    </li>

    <li>
      <span>密码：</span>
      <input type="password" autocomplete="off" class="userInput" v-model="password">
    </li>

    <li>
      <span>重复密码：</span>
      <input type="password" autocomplete="off" class="userInput" v-model="password_confirmation">
    </li>
...
export default {
  data() {
    return {
      ...
      pulicError: "",
      register: [],
      codeImg: "/static/cpzj/img/home/code.jpg",
      captcha_key: "",
      code: "",
      agent: null,
      isCheckbox: true
