...
const register = r => require.ensure([], () => r(require('@/pages/cpzj/home/register')), 'register');
const login = r => require.ensure([], () => r(require('@/pages/cpzj/home/login')), 'login');
const help = r => require.ensure([], () => r(require('@/pages/cpzj/home/help')), 'help');
const moblie = r => require.ensure([], () => r(require('@/pages/cpzj/home/moblie')), 'moblie');
