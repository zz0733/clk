    ...
    <div class="kelake-bot-wrap">
              ...
              <div class="wrap">
                <li :key="index" v-for="(item,index)   in scrollDatas">
                  ...
                  <div class="wintext">
                    ...
                    <div>存款
                      <span>{{item.in==0?100:item.in}}</span>元</div>
                    <div>喜提￥
                      <span>{{+item.out==0?10000:Math.floor(item.out)}}</span>元</div>
                  </div>
                </li>
      ...
      <div class="game-list-right">
        <div class="section_title">
          热门游戏推荐
          <ul class="type">
            <li @click="optionFc(item)" :key='index' v-for="(item,index) in optionList" :class="{'active':optionSel==item.name}">
        ...
        <div class="all">
          ...
          <Carousel ref='carousel' class="all-vrL" v-model="value3" :autoplay="setting.autoplay" :autoplay-speed="setting.autoplaySpeed" :dots="setting.dots" :trigger="setting.trigger" :arrow="setting.arrow2">
        ...
        <div class="slot_game game-bg">
          <Carousel class="slot-vrL" :autoplay="setting.autoplay" :autoplay-speed="setting.autoplaySpeed" :dots="setting.dots" :trigger="setting.trigger" :arrow="setting.arrow">
            <Carousel-item>
              <ul class="item_list">
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'26'}})">
                  <div class="ball">MG</div>
                  <div class="text">MG老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'17'}})">
                  <div class="ball">AG</div>
                  <div class="text">AG老虎机</div>
                </li>
                <li class="item loy" @click="$router.push({path:'/home/games',query:{id:'19'}})">
                  <div class="ball">PT</div>
                  <div class="text">PT老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'32'}})">
                  <div class="ball">CQ9</div>
                  <div class="text">CQ9老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'42'}})">
                  <div class="ball">棋牌</div>
                  <div class="text">开元棋牌</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'31'}})">
            ...
            <Carousel-item>
              <ul class="item_list">
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'29'}})">
                  <div class="ball">JDB</div>
                  <div class="text">JDB电子</div>
                </li>
                <li class="item loy" @click="$router.push({path:'/home/games',query:{id:'18'}})">
                  <div class="ball">BBIN</div>
                  <div class="text">BBIN老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'27'}})">
                  <div class="ball">AE</div>
                  <div class="text">AE老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'30'}})">
                  <div class="ball">DT</div>
                  <div class="text">DT老虎机</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'24'}})">
                  <div class="ball">MW</div>
                  <div class="text">MW棋牌</div>
                </li>
                <li class="item" @click="$router.push({path:'/home/games',query:{id:'28'}})">
        ...
        <div class="live_game">
          <div class="live game-bg">
            <Carousel class="vrL" :autoplay="setting.autoplay" :autoplay-speed="setting.autoplaySpeed" :dots="setting.dots" :trigger="setting.trigger" :arrow="setting.arrow">
              <Carousel-item>
                <ul class="item_list">
        ...
        <div class="fish_game game-bg">
          <ul class="item_list">
            <li class="item" @click="trustLogin({name:'捕鱼王',platform:'AG_GAME',gameName:'548'})">
              <div class="ball">AG</div>
              <div class="text">捕鱼王</div>
            </li>
            <li class="item" @click="trustLogin({name:'深海大赢家',platform:'PT_GAME',gameName:'cashfi'})">
              <div class="ball">PT</div>
              <div class="text">深海大赢家</div>
            </li>
            <li class="item loy" @click="trustLogin({name:'千炮捕鱼',platform:'MW_GAME',gameName:'1051'})">
              <div class="ball">MW</div>
              <div class="text">千炮捕鱼</div>
            </li>
            <li class="item" @click="trustLogin({name:'龙王捕鱼',platform:'JDB_GAME',gameName:'7#7002'})">
              <div class="ball">JDB</div>
              <div class="text">龙王捕鱼</div>
            </li>
            <li class="item" @click="trustLogin({name:'欢乐捕鱼',platform:'FG_GAME',gameName:'fish_hl'})">
              <div class="ball">FG</div>
              <div class="text">欢乐捕鱼</div>
            </li>
            <li class="item" @click="trustLogin({name:'美人捕鱼',platform:'FG_GAME',gameName:'fish_mm'})">
              <div class="ball">FG</div>
        ...
        <div class="lottery_game game-bg">
          <ul class="item_list">
            ...
            <li class="item loy" @click="getItemId({id:'13',platform:'vr_lottery',name:'VR彩票',})">
...
export default {
  ...
  data() {
    return {
      ...
      // 选项选择
      optionList: [
        { name: "PT", id: "19", index: 0 },
        { name: "MG", id: "26", index: 1 },
        { name: "AG", id: "17", index: 2 },
        { name: "CQ9", id: "32", index: 3 },
        { name: "DT", id: "30", index: 4 },
        { name: "AE", id: "27", index: 5 },
        { name: "TTG", id: "28", index: 6 },
        { name: "BBIN", id: "18", index: 7 }
      ],
      optionSel: "PT",
      // 显示图片
      showTypList: [],
...
.new-index {
  ...
  .vp-popout-box {
    ...
    /deep/ .ivu-modal-header {
      ...
      background: #ff0000
        url(/static/klk/img/ui-bg_gloss-wave_45_817865_500x100.png) 50% 50%
        repeat-x;
      color: #ffffff;
      font-weight: bold;
      position: relative;
