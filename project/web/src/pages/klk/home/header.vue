  ...
  <div class="header-top">
    ...
    <div class="login">
      ...
      <div class="login-before" v-if="!userinfo">
        <!-- 用户名 -->
        <div class="username">
          <input type="text" placeholder="账号" id="userName" v-model="passKey.userName" @blur="getCode">
        </div>
        <!-- 密码 -->
        <div class="password">
        ...
        <!-- 验证码 -->
        <div class="code">
          <input maxlength="4" type="text" placeholder="验证码" v-model="passKey.code">
      ...
      <div class="login-after" v-if="userinfo">
        ...
        <div class="part1">
          <span>欢迎您！</span>
          <i class="vip-sprite" :style="{backgroundImage: 'url(' + dengjiImg + ')', backgroundPosition:left+'px '+top+'px'}"></i>
          <span>账号：</span>
