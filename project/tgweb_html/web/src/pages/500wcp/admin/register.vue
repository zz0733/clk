    ...
    <div class="popup">
      ...
      <div class="content">
        ...
        <div class="row">
          <label>用户名:</label>
          <div class="group">
            <input type="text" placeholder="账号（6-10位数字或字母）" maxlength="10" v-model="userName" @blur="getCode">
          </div>
        </div>
        ...
        <div class="row">
          <label>密码:</label>
          <div class="group">
            <input type="password" placeholder="密码（6-20位数字或字母）" maxlength="20" v-model="password">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="password" placeholder="密码（6-20位数字或字母）" maxlength="16" v-model="register_password">
          </div>
        </div>
        ...
        <div class="row">
          <label>验证码:</label>
          <div class="group">
            <input type="text" placeholder="请输入6到10位的数字或字母组合" v-model="code">
            <span class="yzm_reg">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      close () {
        this.$store.commit('500wcp/showRegister', false)
      }
    },
    computed: {
      isResiter () {
  ...
  .register {
    ...
    .popup {
      ...
      .headline {
        ...
        background: url("/static/500wcp/img/bg_reg_title.png");
        p {
          font-size: 24px;
          color: #fff;
          position: absolute;
