<template>
  <div>
    <div class="vp-500wcp-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      <!-- 传统彩票 -->
      ...
      <!-- 主页 -->
      <div v-else class="500wcp-cont-wrap">
...
<script>
  ...
  export default {
    data () {
      return {
        lotHeadDatas: {
          logoUrl: '/static/500wcp/img/logo2.png',
          downLoadurl: '/static/500wcp/html/download/index.html'
        }
      }
    },
    methods: {
