      ...
      <li v-for="(item,i) in navlist" :class="{'nav-active': navActive === i}" :key="i">
        ...
        <ol class="nav-children clear-fix" v-if="item.sub">
          <li v-for="(child, index) in item.sub" :key="index" @click.stop="goThirdParty(child)">
            ...
            <p>{{child.name}}</p>
            <img v-if="child.hot" class="hot" src="/static/500wcp/img/hot.gif">
          </li>
        </ol>
      </li>
    </ul>
            ...
            name: '体育赛事', link: '/home/tiyu', hot: true, en: 'SPORT', sub: [
              {
                ...
                path: '/home/tiyu',
                id: '21',
                icon: '/static/500wcp/img/home/tiyu-icon/SX_SPORT.png'
              },
              {
                name: '沙巴体育',
                path: '/home/tiyu',
                id: '20',
                icon: '/static/500wcp/img/home/tiyu-icon/SB_SPORT.png'
              },
              {
                name: 'BBIN体育',
                path: '/home/tiyu',
                id: '41',
                icon: '/static/500wcp/img/home/tiyu-icon/BBIN_SPORT.png'
              },
              {
                name: 'AG体育',
                path: '/home/tiyu',
                id: '22',
                icon: '/static/500wcp/img/home/tiyu-icon/AG_SPORT.png'
              }
            ]
          },
    ...
    methods: {
      ...
      toggleNav (i, link) {
        if (link == 'kefu') {
          ...
          window.open(
            'https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=83359&configID=41292&jid=9582045656&s=1'
          )
          return false
        }
        if (link == '/plays/hall') {
    ...
    .nav-main {
      ...
      > li {
        ...
        .hot {
          ...
          width: 20px;
          height: 14px;
          background: url("/static/500wcp/img/hot_new.gif") no-repeat;
        }
        &:hover {
          .nav-children {
            display: block;
        ...
        .nav-children {
          ...
          > li {
            ...
            > div {
              ...
              height: 80px;
              margin: 0 auto;
              background-image: url("/static/500wcp/img/game-icon-bg.png");
