<template>
  <div class="footer-main">
    <ul class="footer-child footer-nav clear-fix">
      <li class="nav-item">
        <div class="head-foot" style="width: 202px;height: 47px;background-position: 0 -66px;"></div>
        <div class="head-foot"
    ...
    <div class="footer-child other">
      500万彩票版权所有 ©2008-2018
      <br/>
      500万彩票提醒您：理性购彩，热心公益。未满18周岁的未成年人禁止购彩及兑奖！
    </div>
  </div>
</template>
  ...
  .footer-main {
    ...
    .footer-nav {
      ...
      .nav-item {
        ...
        .head-foot {
          background: url("/static/500wcp/img/headfoot.png") no-repeat;
        }
        .head {
          margin-top: 10px;
          margin-left: 20px;
    ...
    .images {
      ...
      .footer-img {
        ...
        margin: 0 10px;
        float: left;
        background: url("/static/500wcp/img/footer_img.png") no-repeat;
      }
    }
    .other {
      text-align: center;
