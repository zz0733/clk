...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/500wcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/500wcp/home')), 'vpHome')
/* const vpHome = () => import( '@/pages/500wcp/home'); */

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/500wcp/home/home-live')), 'vpHomeLive')
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/500wcp/home/home-contactUs')), 'vpHomeContactUs')
const vpGames = r => require.ensure([], () => r(require('@/pages/500wcp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/500wcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/500wcp/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/500wcp/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/500wcp/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpIssue = r => require.ensure([], () => r(require('@/pages/500wcp/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/500wcp/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/500wcp/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/500wcp/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/500wcp/home/help/relation')), 'vpRelation')
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/500wcp/home/help/about-page')), 'vpAboutPage')
const vpPartnerPage = r => require.ensure([], () => r(require('@/pages/500wcp/home/help/partner-page')), 'vpPartnerPage')
const clause = r => require.ensure([], () => r(require('@/pages/500wcp/home/clause')), 'clause')
