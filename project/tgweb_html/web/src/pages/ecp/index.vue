<template>
  <div>
    <div class="vp-ecp-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      <!-- 传统彩票 -->
      ...
      <!-- 主页 -->
      <div v-else class="ecp-cont-wrap">
...
<script>
  ...
  export default {
    data () {
      return {
        lotHeadDatas: {
          logoUrl: '/static/ecp/img/logo.png',
          downLoadurl: '/static/ecp/html/download/index.html'
        }
      }
    },
    methods: {
