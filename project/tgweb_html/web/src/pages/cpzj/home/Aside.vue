<template>
  <div>
    <div v-show="s1" class="TplFloatSet0 TplFloatSet TplFloatPic_1">
      <div class="dial" @click="openDial"></div>
    ...
    <div class="tip" v-show="s3">
      <img src="/static/cpzj/img/hc_zhuanpan.gif"/>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openKefu () {
        window.open('https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=918069&configID=41399&jid=3557231003&s=1')
      },
      openDial () {
        window.open('https://gzz833.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=918069&configID=41399&jid=3557231003&s=1')
      }
...
<style type="text/less" lang="less" scoped>
  ...
  .TplFloatSet {
    ...
    background: url("/static/cpzj/img/online-right.png") no-repeat;
    .close {
      position: absolute;
      height: 24px;
      width: 100%;
