...
const vpYouhui = r => require.ensure([], () => r(require('@/pages/dqr/home/youhui/index.vue')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/dqr/home/qipai')), 'vpQipai')

const TotalMosaic = r => require.ensure([], () => r(require('@/pages/dqr/home/youhui/totalmosaic.vue')), 'TotalMosaic')

const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/dqr/home/register')), 'register')
const clause = r => require.ensure([], () => r(require('@/pages/dqr/home/clause')), 'clause')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/dqr/home/home-contactUs')), 'vpHomeContactUs')
