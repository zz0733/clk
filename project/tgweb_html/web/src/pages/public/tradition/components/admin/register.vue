  ...
  <div class="register-wrap">
    <div class="list-box">
      <div class="list">
        ...
        账户：
        <input @keydown="pulicError=''" v-on:keyup.enter="registerTest" placeholder="用户名 5-20位数字或字母" type="text"
               v-model="userName" @blur="getCode">
      </div>
      <div class="list">
        <!-- <i class="iconfont icon-mima"></i> -->
        密码：
        <input @keydown="pulicError=''" v-on:keyup.enter="registerTest" placeholder="密码 5-20位数字或字母" type="password"
               v-model="password">
      </div>
      <div class="list">
