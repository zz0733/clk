...
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/fhcp/home/home-contactUs')), 'vpHomeContactUs')
...
const vpIssue = r => require.ensure([], () => r(require('@/pages/fhcp/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/fhcp/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/fhcp/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/fhcp/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/fhcp/home/help/relation')), 'vpRelation')
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/fhcp/home/help/about-page')), 'vpAboutPage')
const vpPartnerPage = r => require.ensure([], () => r(require('@/pages/fhcp/home/help/partner-page')), 'vpPartnerPage')
const clause = r => require.ensure([], () => r(require('@/pages/fhcp/home/clause')), 'clause')
