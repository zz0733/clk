...
<script>
  export default {
    ...
    <p>
        ...
        2. 选择入款额度，并请确实填写 ”联络电话” ，如有任何问题，方便凤凰客服第一时间与您联系。<br>
        3. 选择”支付银行”。<br>
        ...
        5. 进入网络银行页面，请确实填写您银行账号信息，支付成功，额度将在10分钟内系统处理完成，立即加入您的凤凰会员账户。<br>
        <br>
        存款需知:<br>
        凤凰最低存款为$100人民币，最高存款无上限!<br>
