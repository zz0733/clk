...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/500w/index.vue')), 'index')
/* const index = () => import('@/pages/500w/index.vue'); */
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/500w/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/500w/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/500w/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/500w/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/500w/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/500w/home/qipai')), 'vpQipai')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/500w/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/500w/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/500w/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/500w/home/moblie')), 'moblie')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/500w/home/home-contactUs')), 'vpHomeContactUs')
