<template>
  <div class="wbw-register">
    ...
    <ul class="regMain">
      <li>
        <span>账号：</span>
        <input type="text" placeholder="账号（6-10位数字或字母）" autocomplete="off" class="userInput" v-model="userName"
               @blur="getCode">
      </li>

      <li>
        <span>密码：</span>
        <input type="password" placeholder="密码（6-20位数字或字母）" autocomplete="off" class="userInput" v-model="password">
      </li>

      <li>
        <span>重复密码：</span>
        <input type="password" placeholder="密码（6-20位数字或字母）" autocomplete="off" class="userInput"
