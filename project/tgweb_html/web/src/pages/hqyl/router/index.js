...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/hqyl/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/hqyl/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/hqyl/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/hqyl/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/hqyl/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/hqyl/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/hqyl/home/register')), 'register')
const clause = r => require.ensure([], () => r(require('@/pages/hqyl/home/clause')), 'clause')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/hqyl/home/home-contactUs')), 'vpHomeContactUs')
