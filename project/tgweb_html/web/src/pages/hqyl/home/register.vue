            ...
            <div class="register-wrap">
              <div class="list-box">
                <div class="list">
                  ...
                  <input @keydown="pulicError=''" v-on:keyup.enter="registerTest" placeholder="用户名 5-20位数字或字母"
                ...
                <div class="list">
                  ...
                  <input @keydown="pulicError=''" v-on:keyup.enter="registerTest" placeholder="密码 5-20位数字或字母"
                ...
                <!-- <div class="forget">
                            <span>已有账号？<label @click="login">立即登录</label></span>
                        </div> -->
