<template>
  <div>
    <div class="vp-eyc-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      <!-- 传统彩票 -->
      ...
      <!-- 主页 -->
      <div v-else class="eyc-cont-wrap">
...
<script>
  ...
  export default {
    data () {
      return {
        lotHeadDatas: {
          logoUrl: '/static/eyc/img/logo.png',
          downLoadurl: '/static/eyc/html/download/index.html'
        }
      }
    },
    methods: {
