...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/eyc/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/eyc/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/eyc/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/eyc/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/eyc/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/eyc/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/eyc/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/eyc/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const clause = r => require.ensure([], () => r(require('@/pages/eyc/home/clause')), 'clause')
const vpRegister = r => require.ensure([], () => r(require('@/pages/eyc/admin/register')), 'register')
