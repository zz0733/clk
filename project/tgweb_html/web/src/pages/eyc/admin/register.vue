        ...
        <div class="cont-right fr">
            ...
            <div class="content">
              <fieldset>
                ...
                <div class="row">
                  ...
                  <input type="text" maxlength="10" v-model="userName" @blur="getCode">
                  <div class="remark">账号：6-10位数字或字母，支持纯数字，纯字母，及数字与字母的组合</div>
                </div>
                <div class="row">
                  <label><span class="star">*</span>密码:</label>
                  <input type="password" maxlength="20" v-model="password">
                  <div class="remark">密码:6-20位数字或字母，支持纯数字，纯字母，及数字与字母的组合</div>
                </div>
                <div class="row">
                  <label><span class="star">*</span>确认密码:</label>
                  <input type="password" maxlength="20" v-model="register_password">
                </div>
                <div class="row">
          ...
          <div class="page" v-show="page=='about'">
            ...
            <div class="case-article-content">
              ...
              <p><span
                style="font-family: verdana, geneva, sans-serif">在E赢彩的用户都是大赢家，我们将不间断的推出更多优惠，以实际、简单的申请方式迎待各来宾！。</span>
              </p>
              <p><strong><span style="font-family: verdana, geneva, sans-serif">慈善公益</span></strong></p>
              <p><span
                style="font-family: verdana, geneva, sans-serif">E赢彩更肩负起对社会、对慈善公益的责任，也将永不磨灭的针对社会的需要作出更多的贡献。</span></p>
              ...
              <div id="Union">
                ...
                <div id="Union1">
                  ...
                  <p>
                    ...
                    更改银行账号的,必须提前一个星期联系在线客服进行修改，否则本公司一律不负责。E赢彩彩票会评估审核联盟申请讯息，3日内由专员与您联系开通，并提供您的注册账号、密码及推广链接。</p>
                ...
                <div id="Union2" style="display: none;">
                  ...
                  <ol>
                    <li align="left">E赢彩彩票的客服部会登记联盟的会员并会观察他们的投注状况。联盟及会员必须同意并遵守E赢彩彩票的会员条例，政策及操作程序。E赢彩彩票保留拒绝或冻结联盟/会员账户权利
                    </li>
                  ...
                  <ol>
                    <li align="left">
                      代理联盟应尽其所能，广泛地宣传、销售及推广E赢彩彩票，使代理本身及E赢彩彩票的利润最大化。代理联盟可在不违反法律下，以正面形象宣传、销售及推广E赢彩彩票，并有责任义务告知旗下会员所有E赢彩彩票的相关优惠条件及产品。
                    </li>
                  ...
                  <ol>
                    <li align="left">
                      各阶层代理联盟不可在未经E赢彩彩票许可情况下开设双/多个的代理账号，也不可从E赢彩彩票人账户或相关人士赚取佣金。请谨记任何阶层代理不能用代理帐户下注，E赢彩彩票有权终止并封存账号及所有在游戏中赚取的佣金。
                    </li>
                    <li align="left">
                      为确保所有E赢彩彩票会员账号隐私与权益，E赢彩彩票不会提供任何会员密码，或会员个人资料。各阶层代理联盟亦不得以任何方式取得会员数据，或任意登入下层会员账号，如发现代理联盟有侵害E赢彩彩票会员隐私行为，E赢彩彩票有权取消代理联盟红利，并取消代理联盟账号。
                    </li>
                    <li align="left">
                      代理联盟旗下的会员不得开设多于一个的账户。E赢彩彩票有权要求会员提供有效的身份证明以验证会员的身份，并保留以IP判定是否重复会员的权利。如违反上述事项，E赢彩彩票有权终止玩家进行游戏并封存账号及所有于游戏中赚取的佣金
                    </li>
                    <li align="left">代理联盟不可为自己或其他联盟下的有效投注会员,只能是公司直属下的有效投注会员,
                      代理每月需有5个下线有效投注（有效投注为每周至少上线3次进行正常投注），如有违反联盟协议E赢彩彩票有权终止并封存账号及所有在游戏中赚取的佣金。
                    </li>
                    <li align="left">
                      如代理联盟旗下的会员因为违反条例而被禁止享用E赢彩彩票的游戏，或E赢彩彩票退回存款给会员，E赢彩彩票人将不会分配相应的佣金给代理联盟。如代理联盟旗下会员存款用的信用卡、银行资料须经审核，澳门巴黎人保留相关佣金直至审核完成。
                    </li>
                    <li align="left">
                      合约内的条件会以E赢彩彩票通知接受代理联盟加入后开始执行。E赢彩彩票及代理联盟可随时终止此合约，在任何情况下，代理联盟如果想终止合约，都必须以书面/电邮方式提早于七日内通知澳门巴黎人。
                      代理联盟的表现会3个月审核一次，如代理联盟已不是现有的合作成员则本合约书可以在任何时间终止。如合作伙伴违反合约条例，E赢彩彩票有权立即终止合约。
                    </li>
                    <li align="left">
                      在没有E赢彩彩票许可下，代理联盟不能透露及授权E赢彩彩票相关密数据，包括代理联盟所获得的回馈、佣金报表、计算等;代理联盟有义务在合约终止后仍执行机密文件及数据的保密。
                    </li>
...
<style lang="less" scoped>
  ...
  .register {
    .about-banner {
      min-height: 291px;
      background: url(/static/eyc/img/banner/registered-banner.jpg) center no-repeat;
    }
    .abount-main {
      padding: 40px 0px;
      background: #dddddd;
