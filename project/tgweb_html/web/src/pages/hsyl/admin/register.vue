      ...
      <div class="content">
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="password" placeholder="请输入6到20位的数字或字母组合" maxlength="20" v-model="password">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="password" placeholder="请输入6到20位的数字或字母组合" maxlength="20" v-model="register_password">
          </div>
        </div>
