        ...
        navlist: [
          ...
          },
          {
            name: '真人视讯', link: '/home/live', hot: true, en: 'CASINO', sub: [
              {name: 'AG视讯厅', platform: 'live_casino', id: '14', icon: '/static/hsyl/img/live/icon/AG_LIVE.png'},
              {name: 'BBIN视讯厅', platform: 'live_casino', id: '15', icon: '/static/hsyl/img/live/icon/BBIN_LIVE.png'},
              {name: 'BG视讯厅', platform: 'live_casino', id: '44', icon: '/static/hsyl/img/live/icon/BG_LIVE.png'},
              {name: 'DG视讯厅', platform: 'live_casino', id: '33', icon: '/static/hsyl/img/live/icon/DG_LIVE.png'},
              {name: 'DS视讯厅', platform: 'live_casino', id: '16', icon: '/static/hsyl/img/live/icon/DS_LIVE.png'},
              {name: 'LEBO视讯厅', platform: 'live_casino', id: '35', icon: '/static/hsyl/img/live/icon/LEBO_LIVE.png'},
              {name: 'OG视讯厅', platform: 'live_casino', id: '39', icon: '/static/hsyl/img/live/icon/OG_LIVE.png'},
              {name: 'eBET视讯厅', platform: 'live_casino', id: '34', icon: '/static/hsyl/img/live/icon/EBET_LIVE.png'},
              {name: 'LMG视讯厅', platform: 'live_casino', id: '36', icon: '/static/hsyl/img/live/icon/LMG_LIVE.png'},
              {name: '欧博视讯厅', platform: 'live_casino', id: '37', icon: '/static/hsyl/img/live/icon/AB_LIVE.png'},
              {name: 'SA视讯厅', platform: 'live_casino', id: '40', icon: '/static/hsyl/img/live/icon/SA_LIVE.png'}
            ]
          },
