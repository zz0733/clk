                ...
                <span class="info acc-balance">
                  ...
                  <div class="luck-icon" style="display:inline-block; margin-top: -9px; background-image: none;">
                      <span style="width:20px; display:block; padding-top:2px; float:none;">
                          <a href="javascript:void(0)" @click="getBalance()"
                             style="display: inline-block; width: 16px; height: 16px; margin-top: 0px; background: url('/static/test/img/refresh.png')"> </a>
                      </span>
                  </div>
              </span>
              </div>
              <div class="acc-links">
                <a title="会员中心" class="btn btn-navacc-member" href="javascript:void(0);"
                   @click="goUserCen('personage',0)">会员中心</a>
                <a title="在线存款" class="btn btn-navacc-deposit" href="javascript:void(0);"
                   @click="goUserCen('recharge',0)">充值</a>
                <a title="在线取款" class="btn btn-navacc-withdraw" href="javascript:void(0);"
                   @click="goUserCen('withdraw',0)">提款</a>
              ...
              <div class="login-area clear">
                <div class="area-left">
                  <span class="login-mane">
                      <input class="input_tip" id='userName' type="text" size="12" v-model="passKey.userName"
                             title="请填写 4-12 位大小写英数字" maxlength="12" placeholder="会员账号" tabindex="1" required="">
                  </span>
                  <span class="login-code">
                      <input type="text" class="input_tip input_tip_45" size="7" maxlength="4" title="( 点击此处产生新验证码 )"
                             v-model="passKey.code" @keyup.13="login" placeholder="验证码" @focus="getCode"
                             style="width: 45px;">
                  </span>
                  <img title="点击切换验证码" width="62" height="24" :src="codeImg" @click="getCode"
                       style="background-color:white;" alt="验证码">
                  <span class="login-password">
                      <input class="input_tip" type="password" v-model="passKey.password" @keyup.13="login"
                             autocomplete="off" size="13" maxlength="12" title="请填写 6-12 位大小写英数字" placeholder="登录密码"
                             tabindex="2" required="">
                  </span>
                  <a title="登录" href="javascript:void(0)" @click="login" class="btn-login" style="position:relative">
                    <span>登录</span>
                  </a>
                  <a title="忘记密码" :href="$root.config.service[0]&&$root.config.service[0].url" target="_blank"
                     class="btn-member">忘记密码</a>
                </div>
              ...
              <ul class="clear" style="width: 1020px;">
                ...
                <li class="vrLottery">
                  <a href="javascript:void(0);" class="UserCenter"
                     @click="getItemId({id: '13',platform: 'vr_lottery'});">
                ...
                <li>
                  <a href="javascript:void(0);" class="Activity" data-item="ig_hall"
