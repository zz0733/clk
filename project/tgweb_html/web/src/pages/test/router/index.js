...
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/test/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/test/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/test/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/test/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/test/home/youhui/index.vue')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/test/home/qipai')), 'vpQipai')

const TotalMosaic = r => require.ensure([], () => r(require('@/pages/test/home/youhui/totalmosaic.vue')), 'TotalMosaic')

const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/test/home/register')), 'register')
const clause = r => require.ensure([], () => r(require('@/pages/test/home/clause')), 'clause')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/test/home/home-contactUs')), 'vpHomeContactUs')
