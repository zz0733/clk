...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/ddcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/ddcp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/ddcp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/ddcp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/ddcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/ddcp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/ddcp/home/register')), 'register')
const help = r => require.ensure([], () => r(require('@/pages/ddcp/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/ddcp/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/ddcp/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/ddcp/home/sport')), 'vpSport')
const contactUs = r => require.ensure([], () => r(require('@/pages/ddcp/home/contactUs')), 'contactUs')
const clause = r => require.ensure([], () => r(require('@/pages/ddcp/home/clause')), 'clause')
