...
const vpHome = r => require.ensure([], () => r(require('@/pages/500wcp/home/vp-hall/index')), 'vpHome')
      ...
      children:
        [
          // 注册登录
          {
            path: '/admin/login',
            name: 'login',
            component: resolve => require(['@/pages/500wcp/admin/login.vue'], resolve)
          },
          {
            path: '/admin/register',
            component: resolve => require(['@/pages/500wcp/admin/register.vue'], resolve),
