  ...
  export default {
    ...
    filters: {
      capitalize: function (value) {
        try {
          return require(`../../../../../assets/img/public/image/lottery/plays-tradition/side/h5-${value}.png`)
        } catch (err) {
          return require(`../../../../../assets/img/public/image/lottery/plays-tradition/side/h5-default.png`)
        }
      }
    }
  }
