<template>
  ...
  <div class="live">
    ...
    <div id="mescroll" class="mescroll" :class="{mainNone:lotteryDetail ==true}" :style="{height:flag?'0':'100%'}">
      <div class="live-all" v-show="!lotteryDetail" id="dataList" v-if="!flag">
    ...
    <div class="live-detail" v-if="lotteryDetail">
      ...
      <div class="row" v-if="detail.betInfo">
        <label>下注内容</label>
