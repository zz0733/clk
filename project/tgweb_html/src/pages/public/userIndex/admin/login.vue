<template>
  <div class="login-public-css" ref="login">
    ...
    <div class="container-login">
      ...
      <div class="submit-wrap">
        ...
        <div @touchstart="submit" @click="submit" class="submitBt bg-color ">立即登录</div>
      </div>

      <router-link tag="div" to="/admin/register" class="go-register">

        没有帐号？<span class="text-color">立即注册</span>
      </router-link>
    </div>
      ...
      async submit () {
        ...
        if (res && res.code == 200) {
          ...
          if (this.value) {
            ...
            localStorage.remember = JSON.stringify(obj)
          } else {
