            ...
            <div class="jackpot ">
              <div class="dt-jackpot" v-show="$route.query.id!='42'">
                ...
                <div class="jackpotcount">
                  ...
                  <span class="num-item" id="numberfour"
                        style="left:3.44rem;">{{jackpotNum.toString().substring(7,8)}}</span>
                  <span class="num-item" id="numberthree"
                        style="left:3.9rem;">{{jackpotNum.toString().substring(8,9)}}</span>
              ...
              <li>
                <div class="game-info">
                  ...
                  <div class="game-operation">
                    ...
                    <div v-show="Public_User!='test'" class="startgame bg-color" @click="trustLogin(item,0)">立刻游戏</div>
                    <div v-show="Public_User=='test'||!Public_User" class="trygame bg-color"
                         @click="trustLogin(item,1)">免费试玩
                    </div>
                  </div>
                </div>
              </li>
    ...
    <div id="gametypes">
      ...
      <div class="slot-game">
        <div class="providerlist">
          <h3 class="text-color">游戏平台</h3>
          <ul :key="index" v-for="(item,index) in rollList">
            <li>
              <a href="javascript:;" :class="{'bg-color-active':item.id==$route.query.id}"
                 @click="changeprovider(item)">{{item.name}}</a>
            </li>
          </ul>
        </div>
        <div class="typelist">
          ...
          <div v-show='navlist.length' class="typedetail">
            <h3 class="text-color">类型</h3>
            <ul :key="index" v-for="(item,index) in navlist">
              <li>
                <a href="javascript:;" :class="{'bg-color-active':item.tag==currenttype}"
                   @click="choosetype(item,index)">{{item.name}}</a>
              </li>
            </ul>
          </div>
          ...
          <div v-show='linelist.length' class="line">
            <h3 class="text-color">赔付线</h3>
            <ul :key="index" v-for="(item,index) in linelist">
              <li>
                <a href="javascript:;" :class="{'bg-color-active':item.tag==currentline}" @click="chooseline(item)">{{item.name}}</a>
              </li>
            </ul>
          </div>
          ...
          <div v-show='thirtlist.length' class="line">
            <h3 class="text-color">游戏类型</h3>
            <ul :key="index" v-for="(item,index) in thirtlist">
              <li>
                <a href="javascript:;" :class="{'bg-color-active':item.tag==thirtTag}" @click="chooseThirt(item)">{{item.name}}</a>
              </li>
            </ul>
          </div>
