<template>
  <div class="submit-content">
    <div class="submit-title bg-color ">
      <div class="text">
    ...
    <div class="submit-total-box">
      共计:
      <span class="text-color">{{totalObj.num}}</span>注，下注金额
      <span class="text-color"> {{totalObj.momey}} </span>元
    </div>
      ...
      <cube-scroll :data="submitListDatas">
        ...
        <div v-else-if="sideSelect=='合肖'||sideSelect=='全不中'">
          <div class="single-item-wrap">
            ...
            <div class="single-item">{{submitListDatas[0]&&submitListDatas[0].code}}</div>
            <div class="single-item">赔率：{{submitListDatas[0]&&submitListDatas[0].odds}}</div>
            <div class="single-item text-color"> ¥ {{submitMoney}}</div>
          </div>
        </div>
    ...
    <div class="submit-btn">
      ...
      <span @click="sure" class="bg-color">确认</span>
    </div>
  </div>
</template>
