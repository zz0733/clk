              ...
              <li>
                <div class="game-info">
                  ...
                  <div class="game-operation">
                    ...
                    <div v-show="Public_User=='test'||!Public_User" class="trygame" @click="trustLogin(item,1)">免费试玩
                    </div>
                  </div>
                </div>
              </li>
        ...
        <div class="typelist">
          ...
          <div v-show='linelist.length' class="line">
            ...
            <ul :key="index" v-for="(item,index) in linelist">
              <li>
                <a href="javascript:;" :class="{'active':item.tag==currentline}"
                   @click="chooseline(item)">{{item.name}}</a>
              </li>
            </ul>
          </div>
          ...
          <div v-show='thirtlist.length' class="line">
            ...
            <ul :key="index" v-for="(item,index) in thirtlist">
              <li>
                <a href="javascript:;" :class="{'active':item.tag==thirtTag}"
                   @click="chooseThirt(item)">{{item.name}}</a>
              </li>
            </ul>
          </div>
