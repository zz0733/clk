  ...
  <div class="inviteLink">
      ...
      <div id="mescroll" class="mescroll">
        <div class="main" id="dataList">
          <div class="row" v-for="(item,i) in linkData" :key="i">
            <label class="copy" v-clipboard:copy="item.domain" v-clipboard:success="onCopy" v-clipboard:error="onError"
                   ref="linkUrl" for="">
    ...
    <div class="updataLink" v-if="updataLinkShow">
      ...
      <div class="link-content" v-if="!refundLinkShow">
        ...
        <div class="row" v-for="(val,key,i) in refund" :key="i">
          <label>{{key}}:</label>
      ...
      <div class="refundSet" v-if="refundLinkShow">
        ...
        <cube-scroll>
          ...
          <span>
            ...
            <span>
                                          <img
                                            src="../../../../../assets/img/public/image/common/personal/angencyImg/jianshao.png"
                                            alt="" @click="reduce">
                                          <img
                                            src="../../../../../assets/img/public/image/common/personal/angencyImg/zengjia.png"
                                            alt="" @click="increase">
                                      </span>
          </div>

          <div class="refund-content">
            <div class="refund-row" v-for="(item,index) in refundVal" :key="index">
    ...
    <div v-if="!linkData.length" style='margin:2rem 0;text-align: center;'><img
      src='../../../../../assets/img/public/image/common/personal/userInfo/no-data.png' width="60%" alt=''></div>
  </div>
</template>
