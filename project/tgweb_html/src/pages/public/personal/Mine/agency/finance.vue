<template>
  <div class="finance">
    ...
    <div class="content">
      ...
      <div v-if="!teamData.length" style='margin:100px 0;text-align: center;'><img
        src='../../../../../assets/img/public/image/common/personal/userInfo/no-data.png' alt='' width="60%"></div>
    </div>


    <van-picker v-if="timeShow" class="time-picker" @cancel="timeShow =false" @confirm="hanlderTime" show-toolbar
                title="标题" :columns="columns"/>
