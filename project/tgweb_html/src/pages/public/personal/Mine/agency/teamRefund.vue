  ...
  <div class="team-refund">
    ...
    <div class="team-refund-content" v-if="refundShow">
      ...
      <div class="refund-header">
        <span class="fl mh5-back" @click="refundShow = false"></span> 修改{{refundKey}}返水
      </div>

      <cube-scroll>

        <div class="refund-title">
          <span></span> {{refundKey}}返水设置
        </div>
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      localStorage.refundKey = JSON.stringify(this.refundData.userPlatform)
    },
    mounted () {
      self = this
    },
