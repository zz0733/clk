...
const vpHome = r => require.ensure([], () => r(require('@/pages/fhcp/home/vp-hall/index')), 'vpHome')
      ...
      children:
        [
          // 注册登录
          {
            path: '/admin/login',
            name: 'login',
            component: resolve => require(['@/pages/fhcp/admin/login.vue'], resolve)
          },
          {
            path: '/admin/register',
            component: resolve => require(['@/pages/fhcp/admin/register.vue'], resolve),
